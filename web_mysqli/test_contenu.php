...
function DisplayDynamiqueContent($nom_contenu)
{
	...
	$req_get_contenu = mysqli_query($link,$sql_get_contenu) or die('Erreur SQL !<br>'.$sql.'<br>'.mysqli_error($link));
	// on fait une boucle qui va faire un tour pour chaque enregistrement
	while($data_get_contenu = mysqli_fetch_assoc($req_get_contenu))
    {
