...
//	define('SMARTY_DIR','/usr/share/php/smarty' . DIRECTORY_SEPARATOR);
}
if (!defined('SMARTY_CORE_DIR')) {
    define('SMARTY_CORE_DIR', SMARTY_DIR . 'internals' . DIRECTORY_SEPARATOR);
}
//define('SMARTY_DIR','/usr/share/php/smarty' . DIRECTORY_SEPARATOR);
//echo "smarty : ".SMARTY_DIR;
...
class Smarty
{
     ...
     * @var string
     */
    var $template_dir    =  '/var/www/clients/client1/web1/web/templates';
     ...
     * @var string
     */
    var $compile_dir     =  '/var/www/clients/client1/web1/web/templates_c';
     ...
     * @var string
     */
    var $config_dir      =  '/var/www/clients/client1/web1/web/configs';
     ...
     * @var array
     */
    var $plugins_dir     =  array('/var/www/clients/client1/web1/web/plugins');
