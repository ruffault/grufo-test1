...
$sql_validatecommande = "UPDATE `commande`
                         ...
                         LIMIT 1
                        ;";
mysqli_query($link,$sql_validatecommande);
$oldcommande = $_SESSION["code_cmd"];

$code_cmd = code_cmd();

//on cr�e une nouvelle commande non valid�e
...
$subjectadmin = "Commande r�f�rence " . $oldcommande . " � traiter";
$messageadmin = "Bonjour,\n\nLa commande r�f�renc� " . $oldcommande
. " viens d'�tre valid�e le " . date("Y/m/d") . " � "
