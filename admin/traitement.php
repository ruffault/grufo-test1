...
$sql_code = "SELECT code
             ...
             ;";
$sql_code_result = mysql_query($sql_code);
$val_code = mysql_fetch_array($sql_code_result);
...
$res = mysql_query($sql_lang);
$applicationlang = mysql_fetch_array($res);
