...
function titre_barnes($tabhtml) {
  ...
  $titre = eregi_replace('<html><head><title>Barnes&nbsp;&amp;&nbsp;Noble.com -','', $titre);
  $titre = eregi_replace(': [^ù]*','', $titre);
  return $titre;
}
...
//echo $tabhtml[$i];
  ...
  $img = eregi_replace('[^ù]*<img src="http://a1055.g.akamai.net/f/1055/1401/5h/images.barnesandnoble.com/gresources/red_carrot_7x8.gif" width="7" height="8" border="0" alt=" ">&nbsp;<a href="','', $img);

  $img = eregi_replace('">Larger&nbsp;view</a>[^ù]*','', $img);
...
function img_url_amazon($tabhtml) {
  ...
  $img = eregi_replace('<a href="','', $img);
  $img = eregi_replace('"><im[^ù]*','', $img);
