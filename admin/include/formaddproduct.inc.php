...
<tr>
  <td>Existe en format numérique </td>
  <td><input type="radio" name="product_numerique" /></td>
</tr>

<tr>
  <td valign='top'>Auteur*</td>
  <td><input type="text" value="<?php if(isset($_SESSION["product_auteur"])) {echo $_SESSION["product_auteur"];} ?>" name="product_auteur" /><br />ou sélectionner un auteur existant<br />
...
<tr>
  <td>Editeur*</td>
  <td><input type="text" value="<?php if (isset($_SESSION["product_editeur"])) {echo $_SESSION["product_editeur"];} ?>" name="product_editeur" /><br />ou sélectionner un éditeur existant<br />
...
<tr>
  <td>Délai de<br />réapprovisionnement</td>
...
<tr>
  <td>Cocher pour<br /> désactiver</td>
  <td>
  <?php
