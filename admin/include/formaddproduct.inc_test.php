...
if (isset($_GET["modifier"]) && $_GET["modifier"] == 1)
{
  ...
  $sql_modif_result = mysql_query($sql_modif);
  $val_sql_modif = mysql_fetch_array($sql_modif_result);
  ...
  $sql_all_lang = "SELECT id_langue_source, id_langue_cible
                   ...
                   ;";
  $sql_all_lang_result = mysql_query($sql_all_lang);
  $i = 1;
  while($val_alllang = mysql_fetch_array($sql_all_lang_result))
  {
  ...
  $sql_avant = "SELECT *
                ...
                WHERE id_produit = '" . $_GET["id_produit"] . "'
               ;";
  $sql_avant_result = mysql_query($sql_avant);
  if (mysql_num_rows($sql_avant_result))
...
if (isset($_GET["etat"]) && $_GET["etat"] == "Verifier")
{
  //On affiche un aperÁu
  echo "<div id='preview'>";
  echo "RÈfÈrence : " . $_SESSION["product_reference"] . "<br /><br />";
  ...
  {
    //On rÈcupÈre la catÈgorie
    $sql_affichecateg = "SELECT nom_fr as nom
                        FROM categorie
                        WHERE id_categorie = '" . $_SESSION["product_categorie"] . "'
                        ;";
    $sql_affichecateg_result = mysql_query($sql_affichecateg);
    $val_affichecateg = mysql_fetch_array($sql_affichecateg_result);

    echo "CatÈgorie : " . $val_affichecateg["nom"] . "<br />";
  }
  ...
  else
  {
    $nom_auteur = "SELECT nom
                  ...
                  ;";
    $nom_auteur_result = mysql_query($nom_auteur);
    $val_nom_auteur = mysql_fetch_array($nom_auteur_result);
  ...
  else
  {
    $nom_editeur = "SELECT nom
                  ...
                  ;";
    $nom_editeur_result = mysql_query($nom_editeur);
    $val_nom_editeur = mysql_fetch_array($nom_editeur_result);
...
$sql_recuptva = "SELECT id_type, nom_fr as nom
                 ...
                 ORDER by nom
                 ;";
$sql_recuptva_result = mysql_query($sql_recuptva);
if(isset($_SESSION["product_type"]) && $_SESSION["product_type"] != '')
{
  while ($val_recuptva = mysql_fetch_array($sql_recuptva_result))
  {
...
<tr>
  <td>Nom original*</td>
  <td><input type="text" size="50" value="<? if (isset($_SESSION["product_realname"])) {echo $_SESSION["product_realname"];} ?>" name="product_realname" /></td>
</tr>
<tr>
  <td>Nom de l'ouvrage (fr)*</td>
  <td><input type="text" size="50" value="<? if (isset($_SESSION["product_name_fr"])) {echo $_SESSION["product_name_fr"];} ?>" name="product_name_fr" /></td>
</tr>
<tr>
  <td>Nom de l'ouvrage (de) *</td>
  <td><input type="text" size="50" value="<? if (isset($_SESSION["product_name_de"])) {echo $_SESSION["product_name_de"];} ?>" name="product_name_de" /></td>
</tr>
<tr>
  <td>Nom de l'ouvrage (es) *</td>
  <td><input type="text" size="50" value="<? if (isset($_SESSION["product_name_es"])) {echo $_SESSION["product_name_es"];} ?>" name="product_name_es" /></td>
</tr>
<tr>
  <td>Nom de l'ouvrage (it) *</td>
  <td><input type="text" size="50" value="<? if (isset($_SESSION["product_name_it"])) {echo $_SESSION["product_name_it"];} ?>" name="product_name_it" /></td>
</tr>
<tr>
  <td>Nom de l'ouvrage (en) *</td>
  <td><input type="text" size="50" value="<? if (isset($_SESSION["product_name_en"])) {echo $_SESSION["product_name_en"];} ?>" name="product_name_en" /></td>
</tr>

<tr><td colspan='2'><hr /></td></tr>
<tr>
  <td valign='top'>Auteur*</td>
  <td><input type="text" value="<? if(isset($_SESSION["product_auteur"])) {echo $_SESSION["product_auteur"];} ?>" name="product_auteur" /><br />ou sÈlectionner un auteur existant<br />
...
$sql_recupauteur = "SELECT *
                   ...
                   ORDER by nom
                  ;";
$sql_recupauteur_result = mysql_query($sql_recupauteur);
while ($val_recupauteur = mysql_fetch_array($sql_recupauteur_result))
{
...
<tr>
  <td>Editeur*</td>
  <td><input type="text" value="<? if (isset($_SESSION["product_editeur"])) {echo $_SESSION["product_editeur"];} ?>" name="product_editeur" /><br />ou sÈlectionner un Èditeur existant<br />
...
$sql_recupediteur = "SELECT *
                   ...
                   ORDER by nom
                  ;";
$sql_recupediteur_result = mysql_query($sql_recupediteur);
while ($val_recupediteur = mysql_fetch_array($sql_recupediteur_result))
{
...
<tr>
  ...
  <td>
    <select name="product_categorie">
      <option value="<? if (isset($_SESSION["product_categorie"])) {echo $_SESSION["product_categorie"];} ?>"></option>
<?
$sql_recupcateg = "SELECT id_categorie, nom_fr as nom
                   FROM categorie
                   ORDER by nom_fr
                  ;";
$sql_recupcateg_result = mysql_query($sql_recupcateg);
while ($val_recupcateg = mysql_fetch_array($sql_recupcateg_result))
{
...
<tr>
  <td>RÈfÈrence*</td>
  <td><input type="text" size="15" maxlenght="15" value="<? if (isset($_SESSION["product_reference"])) {echo $_SESSION["product_reference"];} ?>" name="product_reference" /></td>
</tr>
<tr>
  <td>ISBN</td>
  <td><input type="text" size="15" maxlenght="15" value="<? if (isset($_SESSION["product_isbn"])) {echo $_SESSION["product_isbn"];} ?>" name="product_isbn" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ISSN <input type="text" size="15" maxlenght="15" value="<? if (isset($_SESSION["product_issn"])) {echo $_SESSION["product_issn"];} ?>" name="product_issn" />
 </td>
</tr>
<tr><td colspan='2'><hr /></td></tr>
<tr>
  <td>Nombre de pages*</td>
  <td><input type="text" size="6" value="<? if (isset($_SESSION["product_page"])) {echo $_SESSION["product_page"];} ?>" name="product_page" />pages</td>
</tr>
<tr>
<td>Nombre de termes*</td>
<td><input type="text" size="8" value="<? if (isset($_SESSION["product_terme"])) {echo $_SESSION["product_terme"];} ?>" name="product_terme" />termes</td>
</tr>
<tr>
<td>Poids</td>
<td><input type="text" value="<? if (isset($_SESSION["product_poid"])) {echo $_SESSION["product_poid"];} ?>" name="product_poid" />grammes</td>
</tr>
<tr><td colspan='2'><hr /></td></tr>
<tr>
  <td>langues</td>
...
$sql_recuplang = "SELECT id_langue_dispo, nom_fr as nom
                  ...
                  ORDER by nom_fr
                  ;";
$sql_recuplang_result = mysql_query($sql_recuplang);

$num = 0;
while ($val_recuplang = mysql_fetch_array($sql_recuplang_result))
{
...
{
	echo "Source&nbsp;";
	echo "<select name='product_source" . ($j+1) . "'>";
	...
	echo "&nbsp;Cible&nbsp;";
	echo "<select name='product_cible" . ($j+1) . "'>";
	echo "<option value=''>&nbsp;</option>";
	$i=0;
	foreach($tabidlang as $v)
	{
...
<tr>
  ...
  <td><textarea cols="50" rows="10" name="product_description_fr"><? if (isset($_SESSION["product_description_fr"])) {echo  stripslashes(html_entity_decode($_SESSION["product_description_fr"]));} ?></textarea></td>
</tr>
<tr>
  <td>Description (de)</td>
  <td><textarea cols="50" rows="10" name="product_description_de"><? if (isset($_SESSION["product_description_de"])) {echo  stripslashes(html_entity_decode($_SESSION["product_description_de"]));} ?></textarea></td>
</tr>
<tr>
  <td>Description (es)</td>
  <td><textarea cols="50" rows="10" name="product_description_es"><? if (isset($_SESSION["product_description_es"])) {echo  stripslashes(html_entity_decode($_SESSION["product_description_es"]));} ?></textarea></td>
</tr>
<tr>
  <td>Description (it)</td>
  <td><textarea cols="50" rows="10" name="product_description_it"><? if (isset($_SESSION["product_description_it"])) {echo  stripslashes(html_entity_decode($_SESSION["product_description_it"]));} ?></textarea></td>
</tr>
<tr>
  <td>Description (en)</td>
  <td><textarea cols="50" rows="10" name="product_description_en"><? if (isset($_SESSION["product_description_en"])) {echo  stripslashes(html_entity_decode($_SESSION["product_description_en"]));} ?></textarea></td>
</tr>
<tr>
  <td>Divers (fr)</td>
  <td><textarea cols="50" rows="10" name="product_divers_fr"><? if (isset($_SESSION["product_divers_fr"])) {echo  stripslashes(html_entity_decode($_SESSION["product_divers_fr"]));} ?></textarea></td>
</tr>
<tr>
  <td>Divers (de)</td>
  <td><textarea cols="50" rows="10" name="product_divers_de"><? if (isset($_SESSION["product_divers_de"])) {echo  stripslashes(html_entity_decode($_SESSION["product_divers_de"]));} ?></textarea></td>
</tr>
<tr>
  <td>Divers (es)</td>
  <td><textarea cols="50" rows="10" name="product_divers_es"><? if (isset($_SESSION["product_divers_es"])) {echo  stripslashes(html_entity_decode($_SESSION["product_divers_es"]));} ?></textarea></td>
</tr>
<tr>
  <td>Divers (it)</td>
  <td><textarea cols="50" rows="10" name="product_divers_it"><? if (isset($_SESSION["product_divers_it"])) {echo  stripslashes(html_entity_decode($_SESSION["product_divers_it"]));} ?></textarea></td>
</tr>
<tr>
  <td>Divers (en)</td>
  <td><textarea cols="50" rows="10" name="product_divers_en"><? if (isset($_SESSION["product_divers_en"])) {echo  stripslashes(html_entity_decode($_SESSION["product_divers_en"]));} ?></textarea></td>
</tr>
<tr><td colspan='2'><hr /></td></tr>
<tr>
  <td>Prix HT *</td>
  <td><input type="text" size="10" maxlenght="10" value="<? if (isset($_SESSION["product_prix"])) {echo $_SESSION["product_prix"];} ?>" name="product_prix" />&euro;</td>
</tr>
<tr>
  <td>Prix Èditeur</td>
  <td><input type="text" size="10" maxlenght="10" value="<? if (isset($_SESSION["product_prix_editeur"])) {echo $_SESSION["product_prix_editeur"];} ?>" name="product_prix_editeur" />&euro;</td>
</tr>
<tr>
  <td>Remise</td>
  <td><input type="text" size="10" maxlenght="10" value="<? if (isset($_SESSION["product_rabais"])) {echo $_SESSION["product_rabais"];} ?>" name="product_rabais" />%</td>
</tr>
<tr>
  <td>Niveau<br />de remise</td>
  <td>
    <select name="product_remise_lvl">
<?
  for($i=0; $i<10; $i++)
  {
...
<tr><td colspan='2'><hr /></td></tr>
<tr>
  <td>DÈlai de<br />rÈapprovisionnement</td>
  <td><input type="text" size="10" maxlenght="10" value="<? if (isset($_SESSION["product_delai_reapprovisionnement"])) {echo $_SESSION["product_delai_reapprovisionnement"];} ?>" name="product_delai_reapprovisionnement" />jours</td>
</tr>
<tr>
  <td>Nombre d'ouvrages<br />disponibles</td>
  <td><input type="text" size="10" maxlenght="10" value="<? if (isset($_SESSION["product_nb_dispo"])) {echo $_SESSION["product_nb_dispo"];} ?>" name="product_nb_dispo" /></td>
</tr>
<tr>
...
<!--<tr>
  <td>Url associÈ</td>
  <td><input type="text" size="50" maxlength="255" value="<? if (isset($_SESSION["product_url"])) {echo $_SESSION["product_url"];}?>" name="product_url" /></td>
</tr>--!>
<tr>
  <td>PDF prÈsentation</td>
  <td><input type="text" size="50" maxlength="255" value="<? if (isset($_SESSION["product_pdfap"])) {echo $_SESSION["product_pdfap"];}?>" name="product_pdfap" /></td>
</tr>
<tr>
...
<tr>
  <td>Cocher pour<br /> dÈsactiver</td>
  <td>
  <?
...
<input type="submit" value="Verifier" name="product_submitaddproduct" /> <input type="submit" value="traduire" name="product_submittradproduct" />
<?
