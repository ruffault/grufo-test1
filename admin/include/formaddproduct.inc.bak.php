...
<tr>
  ...
  <td><input type="text" value="<? if(isset($_SESSION["product_auteur"])) {echo $_SESSION["product_auteur"];} ?>" name="product_auteur" /><br />ou s�lectionner un auteur existant<br />
...
<tr>
  <td>Editeur*</td>
  <td><input type="text" value="<? if (isset($_SESSION["product_editeur"])) {echo $_SESSION["product_editeur"];} ?>" name="product_editeur" /><br />ou s�lectionner un �diteur existant<br />
