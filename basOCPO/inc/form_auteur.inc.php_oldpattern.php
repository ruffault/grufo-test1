...
?>
	...
	<td >
	<input type="text" name="Nom[]" pattern="\w*" value="<?php echo $auteur->Nom();?>" >
	</td>
	<td>
	<input type="text" name="Prénom[]" pattern="\w*" value="<?php echo $auteur->Prénom();?>" >
	</td>
	<td>
	<input type="text" name="Nom_usage[]" pattern="\w*" value="<?php echo $auteur->Nom_usage();?>" >
	</td>
	<td>
	<input type="text" name="Pseudo[]" pattern="\w*" value="<?php echo $auteur->Pseudo();?>" >
	</td>
	<td>
	<input type="mail" name="Nom_courrier[]" value="<?php echo $auteur->Nom_courrier();?>" >
	</td>
	<td>
	<input type="text" name="Adresse[]" pattern="\w*" value="<?php echo $auteur->Adresse();?>" >
	</td>
	<td>
	<input type="text" name="Adresse2[]"  pattern="\w*" value="<?php echo $auteur->Adresse2();?>" >
	</td>
	<td>
	<input type="text" name="CP[]" pattern="\d*" value="<?php echo $auteur->CP();?>" >
	</td>
	<td>
	<input type="text" name="Ville[]" pattern="\w*" value="<?php echo $auteur->Ville();?>" >
	</td>
	<td>
	<input type="text" name="Pays[]" pattern="\w*" value="<?php echo $auteur->Pays();?>" >
	</td>
	<td>
	...
	<td>
	<input type="text" name="Activité[]" pattern="\w*" value="<?php echo $auteur->Activité();?>" >
	</td>
	<td>
