...
<p id= "banretour">
	<?php
		if ((isset($_GET['sup']) ? $_GET['sup'] : '') ) echo "On a supprimé ".$_GET['sup']." auteur(s),</br>";
		if ((isset($_GET['maj']) ? $_GET['maj'] : '') ) echo "On a mis à jour ".$_GET['maj']." auteur(s),</br>";
		if ((isset($_GET['ins']) ? $_GET['ins'] : '') ) echo "On a ajouté ".$_GET['ins']." auteur(s),</br>";
...
?>
	...
	<td > 
	<input class ="chpinput2" type="text" name="Type_cotisant[]"  pattern="[1234]" value="<?php echo $auteur->Type_cotisant();?>" >
	</td>
		<td>
	...
	<input class = "chpinput3" type="text" name="n°_SS[]"  value="<?php echo $auteur->n°_SS();?>" >
	</td>
	<td>
<!--	<input type="text" name="clé_SS[]" pattern="(0[1-9]|[1-8][0-9]|9[0-7])" value="<?php// echo $auteur->clé_SS();?>" >-->
	<input class = "chpinput4" type="text" name="clé_SS[]"  value="<?php echo $auteur->clé_SS();?>" >
	</td>
	<td >
	<input class = "chpinput3" type="text" name="Nom[]" pattern="[\wãåāàâæáäėēęêéèëūüûùúīîïióöôœÂÄÊÉÈËYÜÛUÎÏÖÔŒ/. ',-]*" value="<?php echo $auteur->Nom();?>" >
	</td>
	<td>
	<input class = "chpinput5" type="text" name="Prénom[]" pattern="[\wãåāàâæáäėēęêéèëūüûùúīîïióöôœÂÄÊÉÈËYÜÛUÎÏÖÔŒ/. ',-]*" value="<?php echo $auteur->Prénom();?>" >
	</td>
	<td>
	<input class = "chpinput4" type="text" name="Nom_usage[]" pattern="[\wãåāàâæáäėēęêéèëūüûùúīîïióöôœÂÄÊÉÈËYÜÛUÎÏÖÔŒ/. ',-]*" value="<?php echo $auteur->Nom_usage();?>" >
	</td>
	<td>
	<input class = "chpinput5" type="text" name="Pseudo[]" pattern="[\wãåāàâæáäėēęêéèëūüûùúīîïióöôœÂÄÊÉÈËYÜÛUÎÏÖÔŒ/. ',-]*" value="<?php echo $auteur->Pseudo();?>" >
	</td>
	<td>
	<input class = "chpinput9" type="mail" name="Nom_courrier[]" value="<?php echo $auteur->Nom_courrier();?>" >
	</td>
	<td>
	<input class = "chpinput8" type="text" name="Adresse[]" pattern="[\wãåāàâæáäėēęêéèëūüûùúīîïióöôœÂÄÊÉÈËYÜÛUÎÏÖÔŒ/. ',-]*" value="<?php echo $auteur->Adresse();?>" >
	</td>
	<td>
	<input class = "chpinput5" type="text" name="Adresse2[]"  pattern="[\wãåāàâæáäėēęêéèëūüûùúīîïióöôœÂÄÊÉÈËYÜÛUÎÏÖÔŒ/. ',-]*" value="<?php echo $auteur->Adresse2();?>" >
	</td>
	<td>
	<input class = "chpinput7" type="text" name="CP[]" pattern="\d*" value="<?php echo $auteur->CP();?>" >
	</td>
	<td>
	<input class = "chpinput6" type="text" name="Ville[]" pattern="[\wãåāàâæáäėēęêéèëūüûùúīîïióöôœÂÄÊÉÈËYÜÛUÎÏÖÔŒ/. ',-]*" value="<?php echo $auteur->Ville();?>" >
	</td>
	<td>
	<input class = "chpinput4" type="text" name="Pays[]" pattern="[\wãåāàâæáäėēęêéèëūüûùúīîïióöôœÂÄÊÉÈËYÜÛUÎÏÖÔŒ/. ',-]*" value="<?php echo $auteur->Pays();?>" >
	</td>
	<td>
	<input class = "chpinput4" type="date" name="date_naissance[]" value="<?php echo $auteur->date_naissance();?>" >
	</td>
	<td>
	<input class = "chpinput4" type="date" name="date_décès[]" value="<?php echo $auteur->date_décès();?>" >
	</td>
	<td>
	<input class = "chpinput5" type="text" name="Activité[]" pattern="[\wãåāàâæáäėēęêéèëūüûùúīîïióöôœÂÄÊÉÈËYÜÛUÎÏÖÔŒ/. ',-]*" value="<?php echo $auteur->Activité();?>" >
	</td>
	<td>
	<input class = "chpinput3" type="text" name="Siret_RNA[]" value="<?php echo $auteur->Siret_RNA();?>" >
	</td>
	<td>
	<input class = "chpinput7" type="number" step="0.001" name="Taux_usuel[]" value="<?php echo $auteur->Taux_usuel();?>" >
	</td><td>
	<input class = "chpinput12" type="text" name="Civilité[]" value="<?php echo $auteur->Civilité();?>" >
	</td>
	<td>
	<input class = "chpinput13" type="text" name="Type[]" value="<?php echo $auteur->Type();?>" >
	</td>
	<td>
...
?>
	...
	<td >
	<input class = "chpinput2" type="text" pattern="[1234]" name="Type_cotisant[]" form = "monform" value="" >
	</td>
	<td>
	<input class = "chpinput3" type="text" name="n°_SS[]" form = "monform" value=""  pattern="[123478][0-9]{2}(0[1-9]|1[0-2]|3[1-9]|4[0-2]|[5-9][0-9]|20)([0][1-9]|2[AB]|[1-9][0-9])([0-9]{3})(00[1-9]|0[1-9][0-9]|[1-9][0-9]{2})">
	</td>
	<td>
	<input class = "chpinput4" type="text" name="clé_SS[]" form = "monform" value="" pattern="(0[1-9]|[1-8][0-9]|9[0-7])" >
	</td>
	<td >
	<input class = "chpinput3" type="text" name="Nom[]" form = "monform" value="" >
	</td>
	<td>
	<input class = "chpinput5" type="text" name="Prénom[]" form = "monform" value="" >
	</td>
	<td>
	<input class = "chpinput4" type="text" name="Nom_usage[]" form = "monform" value="" >
	</td>
	<td>
	<input class = "chpinput5" type="text" name="Pseudo[]" form = "monform" value="" >
	</td>
	<td>
	<input class = "chpinput9" type="text" name="Nom_courrier[]" form = "monform" value="" >
	</td>
	<td>
	<input class = "chpinput8" type="text" name="Adresse[]" form = "monform" value="" >
	</td>
	<td>
	<input class = "chpinput5" type="text" name="Adresse2[]" form = "monform" value="" >
	</td>
	<td>
	<input class = "chpinput7" type="text" name="CP[]" form = "monform" value="" >
	</td>
	<td>
	<input class = "chpinput6" type="text" name="Ville[]" form = "monform" value="" >
	</td>
	<td>
	<input class = "chpinput4" type="text" name="Pays[]" form = "monform" value="" >
	</td>
	<td>
	<input class = "chpinput4" type="date" name="date_naissance[]" form = "monform" value="" >
	</td>
	<td>
	<input class = "chpinput4" type="date" name="date_décès[]" form = "monform" value="" >
	</td>
	<td>
	<input class = "chpinput5" type="text" name="Activité[]" form = "monform" value="" >
	</td>
	<td>
	<input class = "chpinput3" type="text" name="Siret_RNA[]" form = "monform" value="" >
	</td>
	<td>
	<input class = "chpinput7" type="number" step="0.001" name="Taux_usuel[]" form = "monform" value=,08 >
	</td><td>
	<input class = "chpinput11" type="text" name="Civilité[]" form = "monform" value="" >
	</td>
	<td>
	<input class = "chpinput12" type="text" name="Type[]" form = "monform" value="" >
	</td>
	<td>
