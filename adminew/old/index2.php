...
<div id="page">
<div id="menutop">
	<div id="logout">Administrateur - <a href="logout.php">Se déconnecter</a></div>
...
<div id="menutop2">
  <ul>
    ...
    <li><a href="index2.php?page=categ"><img src="css/categ.gif" alt="Catégorie" title="Catégorie" /></a></li>
