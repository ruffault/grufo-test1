...
//3 fonctions pour aider admin à gèrer le paramétrage des frais de port
//GR 10 novembre 2020
//
function maj_frais_port_new($pays='fr',$mode_calcul,$mode,$poids_tarif)
{

// il s'agit de mette à jour les donnnées existantes de la table
...
function extractDomain($url)
{
	...
	$url = preg_replace('@/{1}.*@','',$url); // on enleve tout ce qui est précédé de /
	$url = preg_replace('/:{1}.*/','',$url); // on enleve tout ce qui est precedé de : ce qui donne par exemple yatoufourmi.com dans http://www.yatoufourmi.com/index.php:tot
