...
if (isset($_GET["showresult"]) && $_GET["showresult"] == 1)
{
  ...
  {
    $save_sql_search_result = mysqli_query($link,$save_sql_search);
    $nbresult = mysqli_num_rows($save_sql_search_result);
  }
  else
  ...
  if ($nbresult)
  {
    ...
    while($val_result = mysqli_fetch_array($sql_search_result))
    {
	    echo "<tr>";
