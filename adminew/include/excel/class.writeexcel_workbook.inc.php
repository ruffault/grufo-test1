...
function &addworksheet($name="") {
    ...
    // modif GR 18/10/20 remplacé par ligne qui suit $worksheet =& new writeexcel_worksheet($name, $index, $this->_activesheet,
 	$worksheet = new writeexcel_worksheet($name, $index, $this->_activesheet,
                                         $this->_firstsheet,
                                          $this->_url_format, $this->_parser,
                                          $this->_tempdir);

    $this->_worksheets[$index] = $worksheet;    # Store ref for iterator GR 18/10/2020 la aussi j'ai enlevé le &
