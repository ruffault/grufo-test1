...
if ((isset($_GET['tri']) ? $_GET['tri'] : '') == "ref")
  $sql_archive .= "ORDER BY code ";
elseif ((isset($_GET['tri']) ? $_GET['tri'] : '') == "date")
  $sql_archive .= "ORDER BY date_validation ";
elseif ((isset($_GET['tri']) ? $_GET['tri'] : '') == "login")
  $sql_archive .= "ORDER BY login ";
elseif ((isset($_GET['tri']) ? $_GET['tri'] : '') == "nom")
  $sql_archive .= "ORDER BY nom ";
elseif ((isset($_GET['tri']) ? $_GET['tri'] : '') == "prenom")
  $sql_archive .= "ORDER BY prenom ";
elseif ((isset($_GET['tri']) ? $_GET['tri'] : '') == "email")
...
$sql_archive .= ";";
$sql_archive_result = mysqli_query($link,$sql_archive);

echo '<table id="archive">';
echo '<tr>';
echo '<th>&nbsp;</th>';
if ((isset($_GET['tri']) ? $_GET['tri'] : '') == "ref" && $_GET['invert'] == 1)
...
if ((isset($_GET['tri']) ? $_GET['tri'] : '') == "date" && (isset($_GET['invert']) ? $_GET['invert'] : '') == 1)
...
if ((isset($_GET['tri']) ? $_GET['tri'] : '') == "login" && (isset($_GET['invert']) ? $_GET['invert'] : '') == 1)
...
if ((isset($_GET['tri']) ? $_GET['tri'] : '') == "prenom" && (isset($_GET['invert']) ? $_GET['invert'] : '') == 1)
...
if ((isset($_GET['tri']) ? $_GET['tri'] : '') == "nom" && (isset($_GET['invert']) ? $_GET['invert'] : '') == 1)
...
echo '</tr>';
$i=0;
while ($val_archive = mysqli_fetch_array($sql_archive_result))
{
