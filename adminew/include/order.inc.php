...
if (isset($_GET['id_answer']))
{
	...
	//On récupére la réponse type dans la base de données.
...
<div id="order">
			...
			<table style='border: 0;'>
				...
				<tr>
					...
					else if ($cmd_info['statut'] < 6)
					{
						...
						echo '<td>2. Expédition du colis</td>';
					}
					else
					{
						echo '<td>&nbsp;</td>';
						echo '<td class="disable">2. Expédition du colis</td>';
					}
					?>
				</tr>
			</table>
	...
	<div class="box">
		...
		<p>
			...
			<?php if (!empty($address_info['membre_tel']))
							echo 'Tél : ' . utf8_decode($address_info['membre_tel']) . '<br>'; ?>
	...
	<div class="">
		<h2 class="noborder"><img src="css/box7.png" alt="" /> Détail de la commande</h2>
	...
	<tr class='total'>
		<td colspan="7">
			<strong>Montant à recréditer</strong>
		</td>
		<td colspan="3">-</td>
		<td>&nbsp;</td>
	</tr>
	...
	<div class="">
		<h2><img src="css/box8.png" alt=""/> Rédiger un e-mail</h2>
		Commande : <?php echo $cmd_info['code']; ?>
<?php

if (isset($_GET['mail']))
{
	echo "<p><strong>L'email à été corretement envoyé !</strong></p>";
}
...
<!--
	<div class="">
		<h2> Recréditer l'acheteur</h2>
		<p>Montant du versement :</p>
		<input type="text" name="" value="" size="20" />
		<input type="submit" value="Recréditer" />
	</div>
-->
</div>