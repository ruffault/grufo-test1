...
?>
		<form action="include/sup_regle_frais_port.inc.php" method="post">
		<p>
...
?>
		...
		<tr>
		<form id="FP_modif" action="include/edit_regle_frais_port.inc.php" method="post">
		<p> 
...
<?php 			} ?>
	...
	<?php } // fin du champ pour pays export ?>
		...
		<input type="hidden" name="mode_calcul" value="<?php echo (($_GET['type'] == "dup") ? $_GET['mode_calc'] :$row['mode_calcul']); ?>">
		</tr>
		<tr>
