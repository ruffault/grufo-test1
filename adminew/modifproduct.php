...
$_SESSION["product_realname"] = html_entity_decode((isset($_POST["product_realname"]) ? $_POST["product_realname"] : '') );
$_SESSION["product_name_fr"] = html_entity_decode((isset($_POST["product_name_fr"]) ? $_POST["product_name_fr"] : '') );
$_SESSION["product_name_de"] = html_entity_decode((isset($_POST["product_name_de"]) ? $_POST["product_name_de"] : '') );
$_SESSION["product_name_es"] = html_entity_decode((isset($_POST["product_name_es"]) ? $_POST["product_name_es"] : '') );
$_SESSION["product_name_it"] = html_entity_decode((isset($_POST["product_name_it"]) ? $_POST["product_name_it"] : '') );
$_SESSION["product_name_en"] = html_entity_decode((isset($_POST["product_name_en"]) ? $_POST["product_name_en"] : '') );
$_SESSION["product_auteur"] = html_entity_decode((isset($_POST["product_auteur"]) ? $_POST["product_auteur"] : '') );
$_SESSION["product_auteur_choice"] = html_entity_decode((isset($_POST["product_auteur_choice"]) ? $_POST["product_auteur_choice"] : '') );
$_SESSION["product_type"] = html_entity_decode((isset($_POST["product_type"]) ? $_POST["product_type"] : '') );
$_SESSION["product_remise_lvl"] = html_entity_decode((isset($_POST["product_remise_lvl"]) ? $_POST["product_remise_lvl"] : '') );
$_SESSION["product_editeur"] = html_entity_decode((isset($_POST["product_editeur"]) ? $_POST["product_editeur"] : '') );
$_SESSION["product_editeur_choice"] = html_entity_decode((isset($_POST["product_editeur_choice"]) ? $_POST["product_editeur_choice"] : '') );
$_SESSION["product_categorie"] = html_entity_decode((isset($_POST["product_categorie"]) ? $_POST["product_categorie"] : '') );
$_SESSION["product_reference"] = html_entity_decode((isset($_POST["product_reference"]) ? $_POST["product_reference"] : '') );
$_SESSION["product_issn"] = html_entity_decode((isset($_POST["product_issn"]) ? $_POST["product_issn"] : '') );
$_SESSION["product_isbn"] = html_entity_decode((isset($_POST["product_isbn"]) ? $_POST["product_isbn"] : '') );
$_SESSION["product_page"] = html_entity_decode((isset($_POST["product_page"]) ? $_POST["product_page"] : '') );
$_SESSION["product_terme"] = html_entity_decode((isset($_POST["product_terme"]) ? $_POST["product_terme"] : '') );
$_SESSION["product_poid"] = html_entity_decode((isset($_POST["product_poid"]) ? $_POST["product_poid"] : '') );
$_SESSION["product_actif"] = html_entity_decode((isset($_POST["product_actif"]) ? $_POST["product_actif"] : '') );
$_SESSION["product_affaire"] = html_entity_decode((isset($_POST["product_affaire"]) ? $_POST["product_affaire"] : '') );
$_SESSION["product_ofmonth"] = html_entity_decode((isset($_POST["product_ofmonth"]) ? $_POST["product_ofmonth"] : '') );
$_SESSION["product_carrousel"] = html_entity_decode((isset($_POST["product_carrousel"]) ? $_POST["product_carrousel"] : '') );
$_SESSION["product_occasion"] = html_entity_decode((isset($_POST["product_occasion"]) ? $_POST["product_occasion"] : '') );
...
//Nombre de champs langue source langue cible é traiter
$nblangue = 15;
...
$_SESSION["product_description_fr"] = html_entity_decode((isset($_POST["product_description_fr"]) ? $_POST["product_description_fr"] : '') );
$_SESSION["product_description_de"] = html_entity_decode((isset($_POST["product_description_de"]) ? $_POST["product_description_de"] : '') );
$_SESSION["product_description_es"] = html_entity_decode((isset($_POST["product_description_es"]) ? $_POST["product_description_es"] : '') );
$_SESSION["product_description_it"] = html_entity_decode((isset($_POST["product_description_it"]) ? $_POST["product_description_it"] : '') );
$_SESSION["product_description_en"] = html_entity_decode((isset($_POST["product_description_en"]) ? $_POST["product_description_en"] : '') );

$_SESSION["product_divers_fr"] = html_entity_decode((isset($_POST["product_divers_fr"]) ? $_POST["product_divers_fr"] : '') );
$_SESSION["product_divers_de"] = html_entity_decode((isset($_POST["product_divers_de"]) ? $_POST["product_divers_de"] : '') );
$_SESSION["product_divers_es"] = html_entity_decode((isset($_POST["product_divers_es"]) ? $_POST["product_divers_es"] : '') );
$_SESSION["product_divers_it"] = html_entity_decode((isset($_POST["product_divers_it"]) ? $_POST["product_divers_it"] : '') );
$_SESSION["product_divers_en"] = html_entity_decode((isset($_POST["product_divers_en"]) ? $_POST["product_divers_en"] : '') );


$_SESSION["product_prix"] = html_entity_decode((isset($_POST["product_prix"]) ? $_POST["product_prix"] : '') );
$_SESSION["product_prix_editeur"] = html_entity_decode((isset($_POST["product_prix_editeur"]) ? $_POST["product_prix_editeur"] : '') );
$_SESSION["product_rabais"] = html_entity_decode((isset($_POST["product_rabais"]) ? $_POST["product_rabais"] : '') );
$_SESSION["product_delai_reapprovisionnement"] = html_entity_decode((isset($_POST["product_delai_reapprovisionnement"]) ? $_POST["product_delai_reapprovisionnement"] : '') );
$_SESSION["product_nb_dispo"] = html_entity_decode((isset($_POST["product_nb_dispo"]) ? $_POST["product_nb_dispo"] : '') );
...
$_SESSION["product_url"] = html_entity_decode((isset($_POST["product_url"]) ? $_POST["product_url"] : '') );
$_SESSION["product_pdfap"] = html_entity_decode((isset($_POST["product_pdfap"]) ? $_POST["product_pdfap"] : '') );
$_SESSION["product_jourparution"] = html_entity_decode((isset($_POST["product_jourparution"]) ? $_POST["product_jourparution"] : '') );
$_SESSION["product_moisparution"] = html_entity_decode((isset($_POST["product_moisparution"]) ? $_POST["product_moisparution"] : '') );
$_SESSION["product_anneeparution"] = html_entity_decode((isset($_POST["product_anneeparution"]) ? $_POST["product_anneeparution"] : '') );
...
$error = "";
if(checkname($_SESSION["product_type"]))
  $error .= "Type de Produit invalide<br />";
...
if ($_POST["product_submitaddproduct"] == "Ajouter" and $error == "")
{
  //ajout de l'auteur dans la table auteur si l'auteur n'existe pas
	...
	$sql_auteurexist = "SELECT *
											...
											;";
	$sql_auteurexist_result = mysqli_query($link,$sql_auteurexist);
	if(mysqli_num_rows($sql_auteurexist_result))
	{
		$val_auteurexist = mysqli_fetch_array($sql_auteurexist_result);
    ...
    if($_SESSION["product_auteur"])
    {
      $sql_addauteur = "INSERT INTO auteur(
                        ...
                        ;";
      mysqli_query($link,$sql_addauteur);

      //recuperation de l'id de l'auteur
      $_SESSION["product_auteur_choice"] = mysqli_insert_id($link);
    }
  }
  //ajout de l'editeur dans la table editeur si l'editeur n'existe pas
	$sql_editeurexist = "SELECT *
											...
											;";
	$sql_editeurexist_result = mysqli_query($link,$sql_editeurexist);
	if(mysqli_num_rows($sql_editeurexist_result))
	{
		$val_editeurexist = mysqli_fetch_array($sql_editeurexist_result);
    ...
    if($_SESSION["product_editeur"])
    {
      $sql_addediteur = "INSERT INTO editeur(
                        ...
                        ;";
      mysqli_query($link,$sql_addediteur);

      //recuperation de l'id de l'editeur
      $_SESSION["product_editeur_choice"] = mysqli_insert_id($link);
    }
	}
  ...
  $sql_addproduct = "INSERT INTO produit(
                    ...
                    ;";
  mysqli_query($link,$sql_addproduct) or die(mysqli_error($link));

  //recuperation de l'id du produit inséré
  $id_newproduct = mysqli_insert_id($link);
  ...
  for ($d=1; $d < ($nblangue + 1) ;$d++)
  {
    if ((isset($_SESSION["product_source$d"]) or isset($_SESSION["product_cible$d"])) && ($_SESSION["product_source$d"] != "" or $_SESSION["product_cible$d"] != ""))
	{
      $sql_addlangue = "INSERT INTO langue_produit(
                       ...
                       ;";
      mysqli_query($link,$sql_addlangue);
    }
  }
  ...
  if ($_SESSION["product_avant"] == 1)
  {
		...
		$res_vitrine = mysqli_query($link,$sql_vitrine);
		$val_vitrine = mysqli_fetch_assoc($res_vitrine);
    ...
    $sql_ajoutvitrine = "INSERT INTO vitrine(
                        ...
                        ;";
    mysqli_query($link,$sql_ajoutvitrine);
  }
...
if ($_POST["product_submitaddproduct"] == "Enregistrer les modifications" and $error == "")
{
  ...
  //ajout de l'editeur dans la table editeur si l'editeur n'existe pas
	$sql_editeurexist = "SELECT *
											...
											;";
	$sql_editeurexist_result = mysqli_query($link,$sql_editeurexist);
	if(mysqli_num_rows($sql_editeurexist_result) && !$_SESSION['product_editeur_choice'])
	{
		$val_editeurexist = mysqli_fetch_array($sql_editeurexist_result);
		$_SESSION['product_editeur_choice'] = $val_editeurexist['id_editeur'];
	}
  ...
  $sql_addproduct = "UPDATE `produit`
                    ...
                    ;";
  mysqli_query($link,$sql_addproduct);
  ...
  $sql_del_lang = "DELETE FROM langue_produit
                  ...
                  ;";
  mysqli_query($link,$sql_del_lang);
  ...
  $sql_verifpresent = "SELECT *
                       ...
                       WHERE id_produit = '" . $_GET["id_produit"] . "'
                      ;";
  $sql_verifpresent_result = mysqli_query($link,$sql_verifpresent);
  if ($_SESSION["product_avant"] == 1)
  {
    //S'il n'est pas en vitrine, on l'ajoute
    if (!mysqli_num_rows($sql_verifpresent_result))
    {
			$sql_vitrine = 'SELECT count(*) as total FROM vitrine;';
			$res_vitrine = mysqli_query($link,$sql_vitrine);
			$val_vitrine = mysqli_fetch_assoc($res_vitrine);
  ...
  else
  {
    ...
    $sql_enlevevitrine = "DELETE FROM vitrine
                          ...
                          LIMIT 1
                         ;";
    mysqli_query($link,$sql_enlevevitrine);
  }
...
$_SESSION["product_occasion"] = "";
  ...
  //on envoier sur une page confirmant la mise é jour du produit
  $redirection = "index2.php?page=confirmmodif&id_produit=" . $_GET["id_produit"];
  header("location: $redirection");
}

//-------------------------------------------------------------------
//Si on veut supprimer le produit existant


if ($_POST["product_submitaddproduct"] == "Supprimer vraiment ?" and $error == "")
{

// on va supprimer l'enregistrement produit qui correspond a l'id_produit

  $sql_del_prod = "DELETE FROM produit
                   WHERE id_produit = '" . $_GET["id_produit"] . "'
                  ;";
  mysqli_query($link,$sql_del_prod);

//On supprime les anciennes langues associees au produit
...
// on va l'enlever de la vitrine s'il y est
...
$_SESSION["product_occasion"] = "";
  ...
  //on envoie sur une page confirmant la mise a jour du produit
  $redirection = "index2.php?page=confirmmodif&id_produit=" . $_GET["id_produit"];
  header("location: $redirection");
}
...
if ($_POST["product_submittradproduct"] == "traduire" and $error == "")
{
	...
	//On modifie les informations du produit
		$sql_tradproduct = "UPDATE `produit`
                     ...
                     WHERE `id_produit` = '" . addslashes($_GET["id_produit"]) . "' LIMIT 1
                    ;";
		mysqli_query($link,$sql_tradproduct);
...
if (($_POST["product_submitaddproduct"] != "Enregistrer les modifications" && $_POST["product_submitaddproduct"] != "Ajouter" && $_POST["product_submitaddproduct"] != "Supprimer vraiment ?") or $error)
{
