...
<div id="slideshow">
	...
	{*
      <div class="slide">
         ...
         <div class="contenu">
				<a href="http://www.expolangues.fr/conferencesEL/vendredi.html">
				<img width="110"src="{$urlsite}img/expolang-2012.jpg" alt="expo-langues" /></a>
				<h3><a href="http://www.expolangues.fr/conferencesEL/vendredi.html">Une innovation dans l’apprentissage des langues : l’intercompréhension.<br>Présentation de la méthode « EuRom5 ».</a></h3>
				...
				<br><a href="http://www.expolangues.fr/infosEL.html">Infos pratiques</a>
				<br>
