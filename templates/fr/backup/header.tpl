...
{/literal}
  ...
  {/if}
	<meta name="viewport" content="width=device-width,initial-scale=1, user-scalable=no"> <!-- rajoute GR janv2022 -->
	...
	<meta property="og:url" content="https://www.dicoland.com/"/>
...
<div id="all">
  ...
  pour linguistes et traducteurs !</h1>
		...
		{include file="$applicationlang/avataruser.tpl"}
		...
		<ul>
			...
			<li><a href="#innercenter">Aller au contenu</a></li>
					...
					{include file="$applicationlang/colmenuV3.tpl"}
<div class="wrapper">
<!--	<p> Bonjour, vous etes arrivés par erreur sur le site de test de Dicoland <br/>
	Pour atteindre le site Dicoland cliquer sur le lien ci-après <a href="https://www.dicoland.com">DICOLAND</a>
	</p> -->
  <div class="wide">
<!--    <div id="nav">
      <ul>
	...
	{include file="$applicationlang/menuebook.tpl"}
        ...
        <li{if $smarty.get.page == "aide"} id="current"{/if}><a href="{$urlsite}index.php?page=aide">Aide</a></li>
         <li{if $smarty.get.page == "blog"} id="current"{/if}><a href="https://www.dicoland.com/blog/">Blog</a></li>
      </ul>
   </div>
                <div id="search">
  ...
  </div> <!-- fin de la div wide -->
  <!-- j'ajoute ici le block annonce  conditionné par page non défini-->

				{if !$smarty.get.page}
  <section class= "annonce"> <!-- pour inclure toute la partie promotion -->  
	<label
