...
<div id="share-buttons">
    <!-- Email -->
    <a href="mailto:?Subject=Dicoland.com&amp;Body=La%20maison%20du%20dictionnaire%20et%20MediQualis%20!%20 https://www.dicoland.com" style="text-decoration:none">
        <img src="{$urlsite}fr/img/mail-icone.png" alt="Email">
    </a>
 
    <!-- Facebook -->
    <a href="https://www.facebook.com/sharer.php?u={$urisite}" target="_blank" style="text-decoration:none">
        <img src="{$urlsite}fr/img/facebook-icone.png" alt="Facebook">
    </a>
    
    <!-- LinkedIn -->
    <a href="https://www.linkedin.com/shareArticle?mini=true&amp;url={$urisite}" target="_blank" style="text-decoration:none">
	...
	<div class="outer">
		<div class="inner">
			<input
				type="checkbox" id="gauche-toggle"
				name="gauche-toggle" class="menumain-toggle"
			/>
			<div class="left">
				...
				<li><a href="{$urlsite}E-Book-c365">E-Book</a></li>
...
myaccount.tpl					{include file="$applicationlang/aide_commande.tpl"}
			...
			<div class="center">
				<div id='innercenter'>
				{if !$smarty.get.page}
<!--	{include file="$applicationlang/covid.tpl"} mis dans la section annonce de header.tpl -->
					{include file="$applicationlang/carrousel.tpl"}
<!--				{include file="$applicationlang/messages.tpl"} mis dans la section annonce de header.tpl -->
        ...
        <br />
			...
			<div class="right">
				<input
					type="checkbox" id="droite-toggle"
					name="droite-toggle" class="menumain-toggle"
				/>
				<!-- <div id='innerright'>
				{if $smarty.get.page != 'paiementcarte' && $smarty.get.page != 'formmodepaiement'
					&& $smarty.get.page != 'formfraisport' && $smarty.get.page != 'formfacturation'
