<div id='pagefraisport'>
  ...
  <div id="selectport">
    ...
    {section name=frais_port loop=$frais_port}
      ...
      {elseif $frais_port[frais_port].mode == courrier_ordinaire}Courrier ordinaire (<span style="color:red;font-weight:bold">pas de suivi possible</span>)
      ...
      {elseif $frais_port[frais_port].mode == colissimo_eur}Colissimo suivi europe (délai indicatif : 4 jours)
