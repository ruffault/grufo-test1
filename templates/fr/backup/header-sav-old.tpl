...
<head>
  ...
  {elseif $nomvitrine == 1}
    <title>{$namesite} - La maison du dictionnaire spécialisé Plus de 4000 ouvrages pour linguistes et traducteurs !</title>
  {else}
...
{else}
  <meta name="keywords" content="Dicoland.com, lmdd, traduction,dictionnaire,
	...
	livre, phonétique, étymologie,dictionaire, langues, traducteur, dicoland,
	dico-land, terminologique, terminologie, onomatopées, suffixe, prononciation,
	abréviations, anglicisme, synonymes, synonyme, medical, francophone, synonimes, technique, philosophique,
...
<div id="all" style="margin-top:-15px;">
  <div id="mininavi">
	...
	<div class="header">
		...
		{elseif $nomvitrine == 1}
			<h1>{$namesite} - La maison du dictionnaire spécialisé Plus de 4000 ouvrages pour linguistes et traducteurs !</h1>
		{else}
			<h1>{$namesite}</h1>
		{/if}
		<a href="{$urlsite}" id="logo"></a>
		<p>La boutique de dictionnaires spécialisés. Méthodes de langues, CDROMS, guides, vocabulaires, lexiques, terminologie... Tout y est ! </p>
		<ul>
  ...
  <div class="wide">
    <div id="nav">
      <ul>
        ...
        <li{if $smarty.get.page == "catediteur" and $show_catalogue_lmdd} id="current"{/if}><a href="{$urlsite}catalogue-editeur-la-maison-du-dictionnaire-e12">Nos éditions</a></li>
        ...
        <li{if $smarty.get.page == "occasion"} id="current"{/if}><a href="{$urlsite}index.php?page=occasion">Nos occasions</a></li>
        <li{if $smarty.get.page == "quisommenous"} id="current"{/if}><a href="{$urlsite}index.php?page=quisommenous">Qui somme nous?</a></li>
