...
*/
	...
	.top-nav-label, .texte-top-nav-lable {
		text-align: middle;
	}
/*	.menu-barre {
		position: fixed;
		...
		<nav class="GlobalNav-menu">
			<ul class="menu-main">
				...
				<li class="Nos menumain-item">
					...
					<div class="nos-nav">
						<ul>
							<li class="submenunos_item" {if $smarty.get.page == "catalogue"} id="current"{/if}>
								<a href="{$urlsite}catalogue-editeur-mediqualis-e12">Catalogue LMD-Dicoland</a>
							</li>
							<li class="submenunos_item" {if $smarty.get.page == "catalogue"} id="current"{/if}>
								<a href="{$urlsite}catalogue-editeur-mediqualis-e0">Catalogue MédiQualis-M'édite</a>
							</li>
						</ul>	
					</div>
				</li><!-- fin du menu-item Nos -->

				<li class="ebook menumain-item" {if $smarty.get.page == "catalogue"} id="current"{/if}>
					<a href="{$urlsite}E-Book-c365">E-Book</a>
				</li>
	
				<li class="occasion menumain-item" {if $smarty.get.page == "occasion"} id="current"{/if}>
					<a href="{$urlsite}index.php?page=occasion">Occasion</a>
				</li>
				<li class="contact menumain-item" {if $smarty.get.page == "contact"} id="current"{/if}>
					<a href="{$urlsite}contact">Contact</a>
				</li>
				<li class="occasion menumain-item" {if $smarty.get.page == "aide"} id="current"{/if}>
