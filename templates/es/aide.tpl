...
Cuando esté registrado, podrá <a href='{$urlsite}verifmembre.php'>confirmar sus pedidos</a>
más rápido, guardar su <a href='{$urlsite}index.php?page=showpanier'>cesta</a> y, si lo desea, recibir nuestro 
...
de su pedido en la parte <a href="{$urlsite}index.php?page=oldcommande">estado de mi pedido</a>,así como todo el histórico de las compras efectuadas.</p>
...
<p>Podrá acceder a la búsqueda avanzada mediante el enlace <a href='{$urlsite}index.php?page=advancedsearch'>Búsqueda avanzada</a>
...
<p>
<a href='{$urlsite}catalogue-0-tous.html'>El catálogo</a> le permite realizar búsquedas de
...
a la página principal del catálogo mediante el enlace <a href="{$urlsite}catalogue-0-tous.html">catálogo</a>.</p>
...
<p>Cuando desee pasar un pedido sólo tiene que hacer clic en <a href="{$urlsite}verifmembre.php">Confirmar el pedido</a> en su cesta de la compra o en su barra de menú situada a la derecha de la pantalla.
...
que se encuentra en la sección <a href='{$urlsite}index.php?page=contact'>contacto</a>. Estaremos encantados de responderle
...
<p>
  ...
  <a href="{$urlsite}index.php?page=lastpass">formulario de recuperación de contraseña</a>.
