...
<ul>
  <li><a href="{$urlsite}index.php?page=modifpref">Modificare i miei dati</a>
	<p>Qui è possibile modificare il tuo indirizzo, la tua password, ecc.</p></li>
	
  <li><a href="{$urlsite}index.php?page=oldcommande">Seguire lo stato dei miei ordini 
  online</a>
  ...
  <li><a href="{$urlsite}index.php?page=showpanier">Visualizzare il mio carrello</a>
...
<p><a href="{$urlsite}index.php?page=forminscription&amp;newaccount=1">Registrati</a>, è semplice e veloce.</p>
{/if}
</div>
