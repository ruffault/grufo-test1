...
<h2><span class="deco">></span>Ordine numero {$smarty.get.no}</h2>
...
{if $produit}
	{section name=produit loop=$produit}
      ...
      {if $produit[produit].quantite > 1}
        <br /><em>(ordinato in {$produit[produit].quantite} esemplari)</em>
  		{/if}
  		</div>
  		<hr />
	{/section}
...
<a href='{$urlsite}index.php?page=oldcommande'>Visualizza l'elenco dei tuoi ordini precedenti</a>
</div>
