<div id='formfacturation'>
  ...
  <form method="post" action="{$urlsite}verifformfacturation.php">
    ...
    <input type="image" name="facturation_submit" value="Use this adress" src="{$urlsite}lang/{$applicationlang}/img/adresse.gif" />
  </form>
  Or
  <br />
  <br />
  <form method="post" action="{$urlsite}verifformfacturation.php">
    ...
    <input type="image" name="facturation_submit" value="Use another adress" src="{$urlsite}lang/{$applicationlang}/img/autreadresse.gif" />
  </form>
  </div>
</div>
