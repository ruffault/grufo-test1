    ...
    <div>
      ...
      {if $samecateg2[samecateg2].rabais != '0.00' && $samecateg2[samecateg2].prix ne '0.00'}
        {if $smarty.session.ht  == "ht"}
          <strong>{$samecateg2[samecateg2].prix_rabais_ht}€ excl. VAT ({$samecateg2[samecateg2].prix_rabais}€ incl. VAT)</strong>
        {else}
          <strong>{$samecateg2[samecateg2].prix_rabais}€ incl. VAT ({$samecateg2[samecateg2].prix_rabais_ht}€ excl. VAT)</strong>
        {/if}
      {elseif $samecateg2[samecateg2].prix ne '0.00'}
        {if $smarty.session.ht  == "ht"}
      		<strong>{$samecateg2[samecateg2].prix_ht}€ excl. VAT({$samecateg2[samecateg2].prix}€ incl. VAT)</strong>
        {else}
      		<strong>{$samecateg2[samecateg2].prix}€ incl. VAT({$samecateg2[samecateg2].prix_ht}€ excl. VAT)</strong>
        {/if}
      {/if}
      </dd>
    	</dl>
