<div id='formlivraison'>
  ...
  <form method="post" action="{$urlsite}verifformlivraison.php">
    ...
    <input type="image" name="livraison_submit" value="Diese Adresse benutzen" src="{$urlsite}lang/{$applicationlang}/img/adresse.gif" />
  </form>
  Oder
  <br />
  <br />
  <form method="post" action="{$urlsite}verifformlivraison.php">
    ...
    <input type="image" name="livraison_submit" value="Eine andere Adresse benutzen" src="{$urlsite}lang/{$applicationlang}/img/autreadresse.gif" />
  </form>
  </div>
</div>
