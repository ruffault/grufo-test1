  ...
  <div>
      ...
      {if $sameauteur[sameauteur].rabais != '0.00' && $sameauteur[sameauteur].prix ne '0.00'}
        {if $smarty.session.ht  == "ht"}
          <strong>{$sameauteur[sameauteur].prix_rabais_ht}€ zzgl. MwSt ({$sameauteur[sameauteur].prix_rabais}€ einshl. MwSt)</strong>
        {else}
          <strong>{$sameauteur[sameauteur].prix_rabais}€ einschl. MwSt ({$sameauteur[sameauteur].prix_rabais_ht}€ zzgl. MwSt)</strong>
        {/if}
      {else}
        {if $smarty.session.ht  == "ht" && $sameauteur[sameauteur].prix ne '0.00'}
      		<strong>{$sameauteur[sameauteur].prix_ht}€ zzgl. MwSt({$sameauteur[sameauteur].prix}€ einschl. MwSt)</strong>
        {elseif $sameauteur[sameauteur].prix ne '0.00'}
      		<strong>{$sameauteur[sameauteur].prix}€ einschl. MwSt({$sameauteur[sameauteur].prix_ht}€ zzgl. MwSt)</strong>
        {/if}
      {/if}
      </dd>
  	</dl>
