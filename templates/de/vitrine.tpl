<div id='vithome'>
    ...
    {if $vitrine[vitrine].rabais != '0.00'}
      {if $smarty.session.ht  == "ht"}
        <strong>{$vitrine[vitrine].prix_rabais_ht} € zzgl. MwSt ({$vitrine[vitrine].prix_rabais} € einschl. MwSt)</strong>
      {else}
        <strong>{$vitrine[vitrine].prix_rabais} € einschl. MwSt ({$vitrine[vitrine].prix_rabais_ht} € zzgl. MwSt)</strong>
      {/if}
    {else}
      {if $smarty.session.ht  == "ht"}
    		<strong>{$vitrine[vitrine].prix_ht} € zzgl. MwSt ({$vitrine[vitrine].prix} € einschl. MwSt)</strong>
      {else}
    		<strong>{$vitrine[vitrine].prix} € einschl. MwSt ({$vitrine[vitrine].prix_ht} € zzgl. MwSt)</strong>
      {/if}
    {/if}
	</div>
    			{if $vitrine[vitrine].prix != 0 && $vitrine[vitrine].sommeil != 1}
    				<form class="addpan"  method="get" action="{$urlsite}addtopanier.php?nbpage=1&amp;pagecourante=1&amp;nbresult=1">
      					<div>
        					<input type="image" value="In den Warenkorb" src="{$urlsite}lang/{$applicationlang}/img/addpan.png"/>
