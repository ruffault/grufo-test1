...
Nach der Anmeldung <a href='{$urlsite}verifmembre.php'>können Sie Ihre Bestellungen </a>
schneller freigeben, den Inhalt Ihres <a href='{$urlsite}index.php?page=showpanier'>Warenkorb abspeichern</a> und auf Wunsch unseren Infobrief abonnieren.</p>
...
Dicoland.com einloggen. So können Sie unter <a href="{$urlsite}index.php?page=oldcommande">Ihre Bestellungen verfolgen</a> die Bearbeitung Ihrer Bestellungen 
...
<p>Die erweiterte Suche ist über den Link <a href='{$urlsite}index.php?page=advancedsearch'>Erweiterte Suche</a>
...
<p>
Im <a href='{$urlsite}catalogue-0-tous.html'>Katalog</a> können Sie Artikel nach 
...
Über den Link <a href="{$urlsite}catalogue-0-tous.html">Katalog</a>.</p> können Sie auch direkt
...
<p>Wenn Sie eine Bestellung aufgeben möchten, klicken Sie direkt auf <a href="{$urlsite}verifmembre.php">
...
Formular in der Rubrik <a href='{$urlsite}index.php?page=contact'>Kontakt</a>. 
...
<p>
 ...
 benutzen Sie bitte das Formular <a href="{$urlsite}index.php?page=lastpass"> zur Passwort-Neuvergabe</a>. 
