...
$sql_verifuser = "SELECT id_membre
                 ...
                 AND enable = 1
								 ;";
$sql_verifuser_result = mysqli_query($link,$sql_verifuser);
$sql_verifuser_result2 = mysqli_query($link,$sql_verifuser);

//si l'utilisateur existe
if (mysqli_fetch_row($sql_verifuser_result))
{
	$is_valid = 1;
  $val_id_user = mysqli_fetch_array($sql_verifuser_result2);
