...
if (!$error_livr)
{
  ...
  mysqli_query($link,$sql_livraison);

  //on passe l'id de cette livraison en session
  $_SESSION["id_livraison"] = mysqli_insert_id($link);
  // GR 30 octobre 2020 on passe pays livraison en session
  $_SESSION["pays_livraison"] = $_POST["livraison_pays"];
