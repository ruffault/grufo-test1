...
/**
 *   Example of a direct redirection to COFIDIS 1Euro
 */
class Cofidis1EuroDirectRedirectionExample implements IPaymentRequestExample
{
    ...
    public function __construct()
    {
         ...
         */
        // Automatic redirection to the cofidis form
        $paymentRequest->setProtocole(PaymentProtocol::COFIDIS_1_EURO);
    ...
    {
        return "This example shows how to redirect the user to a partner payment mean without showing the payment page itself.";
    }

    public function getName()
    {
        return "COFIDIS direct redirection (requires COFIDIS option on your EPT)";
    }
