...
function first_referers($ip)
{
	if(isset($ip))
	{
		...
		if(isset($val['referant']))
		{
			...
			$referant = preg_replace('/*', '',$referant);
...
$sql_verifloginexist = "SELECT login
                        ...
                        ;";
$sql_verifloginexist_result = mysqli_query($link,$sql_verifloginexist);
if (mysqli_num_rows($sql_verifloginexist_result))
...
$sql_verifemailexist = "SELECT email
                        ...
                        ;";
$sql_verifemailexist_result = mysqli_query($link,$sql_verifemailexist);
if (mysqli_num_rows($sql_verifemailexist_result))
...
if (!$error_inscript)
{
  ...
  mysqli_query($link,$sql_newmember);
  ...
  $sql_newiduser = "SELECT id_membre
                    ...
                    ;";
  $sql_newiduser_result = mysqli_query($link,$sql_newiduser);
  $val = mysqli_fetch_array($sql_newiduser_result);
