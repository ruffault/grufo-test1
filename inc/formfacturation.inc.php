...
//  require("tablepays");
  ...
  $facturation = array(
    'civilite' => (isset($_SESSION['facturation_civilite']) ? $_SESSION['facturation_civilite'] : '') ,
    'nom' => (isset($_SESSION['facturation_nom']) ? $_SESSION['facturation_nom'] : '') ,
    'prenom' => (isset($_SESSION['facturation_prenom']) ? $_SESSION['facturation_prenom'] : '') ,
    'adresse1' => (isset($_SESSION['facturation_adresse1']) ? $_SESSION['facturation_adresse1'] : '') ,
    'adresse2' => (isset($_SESSION['facturation_adresse2']) ? $_SESSION['facturation_adresse2'] : '') ,
    'adresse3' => (isset($_SESSION['facturation_adresse3']) ? $_SESSION['facturation_adresse3'] : '') ,
    'cp' => (isset($_SESSION['facturation_cp']) ? $_SESSION['facturation_cp'] : '') ,
    'ville' => (isset($_SESSION['facturation_ville']) ? $_SESSION['facturation_ville'] : '') ,
    'etat' => (isset($_SESSION['facturation_etat']) ? $_SESSION['facturation_etat'] : '')
  );
