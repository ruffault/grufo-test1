...
if (mysqli_num_rows($session_result) < 1 && isset($_SESSION["sessionid"]))
  session_unset();
$_SESSION['applicationlang'] = isset($_SESSION['applicationlang']) ? $_SESSION['applicationlang'] : '';
//echo "session applicationlang et get(aplan] valent:" . $_SESSION['applicationlang'] . isset($_GET['aplan']);
