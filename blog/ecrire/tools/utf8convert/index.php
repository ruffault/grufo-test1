...
else
{
	...
	elseif ($step == 2)
	{
		...
		if ($err != '') {
			...
			buffer::str(
			'<p>'.__('Entries succesfully converted.').'</p>'.
	...
	elseif ($step == 3)
	{
		...
		if ($err != '') {
			...
			buffer::str(
			'<p>'.__('Categories succesfully converted.').'</p>'.
	...
	elseif ($step == 4)
	{
		...
		if ($err != '') {
			...
			buffer::str(
			'<p>'.__('Comments succesfully converted.').'</p>'.
	...
	elseif ($step == 5)
	{
		...
		if ($err != '') {
			...
			buffer::str(
			'<p>'.__('Users succesfully converted.').'</p>'.
	...
	elseif ($step == 6)
	{
		...
		if ($err != '') {
			...
			buffer::str(
			'<p>'.__('Links succesfully converted.').'</p>'.
