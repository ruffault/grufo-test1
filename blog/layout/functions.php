...
La propriété __name__ peut prendre les valeurs suivantes :
...
de substitution __s__ passée en argument. Par exemple:
...
est ''cal''. Les nom des jours sont indiqués avec des cellules d'en-tête
(th) et le titre
avec (caption).
...
limiter le nombre de mots affichés avec le paramère __part__.
...
n'affiche rien. Le paramètre __s__ permet d'ajouter des information lors
...
le contenu du billet. Si elle affiche le chapô, le paramètre __l__ permet
de définir un texte à afficher après le chapô. Dans le paramètre __l__ la
chaîne %s indique le lien vers le billet. On pourra donc par exemple faire
ceci :
...
de la date en changeant le paramètre __format__. Par défaut, ce paramètre
...
précédent. Le paramètre __dir__ indique la direction dans laquelle chercher
le billet (1 pour suivant, -1 pour précédent). Le paramètre __s__ est une
