<?php /* Smarty version 2.6.31, created on 2019-11-07 18:12:00
         compiled from fr/showresult.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'product_link', 'fr/showresult.tpl', 7, false),array('modifier', 'utf8_encode', 'fr/showresult.tpl', 17, false),array('modifier', 'truncate', 'fr/showresult.tpl', 84, false),array('function', 'cycle', 'fr/showresult.tpl', 50, false),)), $this); ?>
<div id="showresult">
...
"> <?php echo ((is_array($_tmp=$this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['nom'])) ? $this->_run_mod_handler('utf8_encode', true, $_tmp) : utf8_encode($_tmp)); ?>
			...
			<dd>
				<?php if ($this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['disponible'] == 0 && $this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['delai_reapprovisionnement'] && $this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['prix'] != '0.00' && $this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['sommeil'] != 1): ?>
					Article disponible sous <?php echo $this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['delai_reapprovisionnement']; ?>
 jours
 ...
 € HT (<?php echo $this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['prix_rabais']; ?>
€ TTC)<br />
        <?php else: ?>
          <?php echo $this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['prix_rabais']; ?>
 € TTC (<?php echo $this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['prix_rabais_ht']; ?>
€ HT)<br />
        <?php endif; ?>
...
€ HT(<?php echo $this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['prix']; ?>
€ TTC)
        <?php else: ?>
      		<?php echo $this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['prix']; ?>
€ TTC(<?php echo $this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['prix_ht']; ?>
€ HT)
        <?php endif; ?>
      <?php endif; ?>
      </strong>
...
Vous pouvez aussi <a href="<?php echo $this->_tpl_vars['urlsite']; ?>
dictionnaire-et-lexique-c0">parcourir le catalogue</a> ou utiliser les catégories dans la barre de menu situé à gauche.
</p>
<h3><span class="deco">></span>Vous recherchez un ouvrage particulier ?</h3>
<p>
	Donnez nous le titre ou  l'<acronym title="International Standard Book Number">ISBN</acronym> de l'ouvrage grâce au <a href="<?php echo $this->_tpl_vars['urlsite']; ?>
index.php?page=contact">formulaire de contact</a>. Nous vous proposerons l'article en quelques instants.
</p>
