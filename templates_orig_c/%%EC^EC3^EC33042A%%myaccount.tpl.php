<?php /* Smarty version 2.6.31, created on 2019-11-18 03:40:33
         compiled from es/myaccount.tpl */ ?>
<div id="myaccount">
...
index.php?page=modifpref">Modificar mis datos</a>
	<p>Aquí puede modificar su dirección, su contraseña, etc.</p></li>
	
  <li><a href="<?php echo $this->_tpl_vars['urlsite']; ?>
index.php?page=oldcommande">Consultar el estado de mis pedidos
  en directo</a>
  ...
  <li><a href="<?php echo $this->_tpl_vars['urlsite']; ?>
index.php?page=showpanier">Ver mi cesta de la compra</a>
...
index.php?page=lastpass'>¿Ha perdido su constraseña?</a>
</p>
</form>
<h3>¿Todavía no se ha registrado?</h3>
<p><a href="<?php echo $this->_tpl_vars['urlsite']; ?>
index.php?page=forminscription&amp;newaccount=1">¡Regístrese!</a>, es fácil y rápido.</p>
<?php endif; ?>
</div>