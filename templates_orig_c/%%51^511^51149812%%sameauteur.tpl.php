<?php /* Smarty version 2.6.31, created on 2019-11-17 15:23:29
         compiled from de/sameauteur.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'product_link', 'de/sameauteur.tpl', 10, false),array('modifier', 'utf8_encode', 'de/sameauteur.tpl', 16, false),array('function', 'cycle', 'de/sameauteur.tpl', 34, false),)), $this); ?>
<?php if ($this->_tpl_vars['sameauteur']): ?>
<div id="sameauteur"><br>
  <h4><span class="deco">&gt;</span>Vom gleichen Autor</h4>
  <div>
...
€ zzgl. MwSt (<?php echo $this->_tpl_vars['sameauteur'][$this->_sections['sameauteur']['index']]['prix_rabais']; ?>
€ einshl. MwSt)</strong>
        <?php else: ?>
          <strong><?php echo $this->_tpl_vars['sameauteur'][$this->_sections['sameauteur']['index']]['prix_rabais']; ?>
€ einschl. MwSt (<?php echo $this->_tpl_vars['sameauteur'][$this->_sections['sameauteur']['index']]['prix_rabais_ht']; ?>
€ zzgl. MwSt)</strong>
        <?php endif; ?>
      <?php else: ?>
...
€ zzgl. MwSt(<?php echo $this->_tpl_vars['sameauteur'][$this->_sections['sameauteur']['index']]['prix']; ?>
€ einschl. MwSt)</strong>
...
€ einschl. MwSt(<?php echo $this->_tpl_vars['sameauteur'][$this->_sections['sameauteur']['index']]['prix_ht']; ?>
€ zzgl. MwSt)</strong>
        <?php endif; ?>
      <?php endif; ?>
      </dd>
