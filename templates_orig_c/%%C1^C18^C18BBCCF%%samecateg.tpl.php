<?php /* Smarty version 2.6.31, created on 2019-10-30 01:11:55
         compiled from fr/samecateg.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'product_link', 'fr/samecateg.tpl', 9, false),array('modifier', 'utf8_encode', 'fr/samecateg.tpl', 15, false),array('function', 'cycle', 'fr/samecateg.tpl', 37, false),)), $this); ?>
...
€ HT (<?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix_rabais']; ?>
€ TTC)</strong>
        <?php else: ?>
          <strong><?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix_rabais']; ?>
€ TTC (<?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix_rabais_ht']; ?>
€ HT)</strong>
        <?php endif; ?>
        </span>
...
€ HT(<?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix']; ?>
€ TTC)</strong>
        <?php else: ?>
      		<strong><?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix']; ?>
€ TTC(<?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix_ht']; ?>
€ HT)</strong>
        <?php endif; ?>
        </span>
      <?php endif; ?>
