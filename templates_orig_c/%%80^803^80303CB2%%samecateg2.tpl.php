<?php /* Smarty version 2.6.31, created on 2019-11-18 03:40:42
         compiled from es/samecateg2.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'product_link', 'es/samecateg2.tpl', 10, false),array('modifier', 'utf8_encode', 'es/samecateg2.tpl', 16, false),array('function', 'cycle', 'es/samecateg2.tpl', 34, false),)), $this); ?>
...
€ sin IVA (<?php echo $this->_tpl_vars['samecateg2'][$this->_sections['samecateg2']['index']]['prix_rabais']; ?>
€ con IVA)</strong>
        <?php else: ?>
          <strong><?php echo $this->_tpl_vars['samecateg2'][$this->_sections['samecateg2']['index']]['prix_rabais']; ?>
€ con IVA (<?php echo $this->_tpl_vars['samecateg2'][$this->_sections['samecateg2']['index']]['prix_rabais_ht']; ?>
€ sin IVA)</strong>
        <?php endif; ?>
...
€ sin IVA(<?php echo $this->_tpl_vars['samecateg2'][$this->_sections['samecateg2']['index']]['prix']; ?>
€ con IVA)</strong>
        <?php else: ?>
      		<strong><?php echo $this->_tpl_vars['samecateg2'][$this->_sections['samecateg2']['index']]['prix']; ?>
€ con IVA(<?php echo $this->_tpl_vars['samecateg2'][$this->_sections['samecateg2']['index']]['prix_ht']; ?>
€ sin IVA)</strong>
        <?php endif; ?>
      <?php endif; ?>
      </dd>
