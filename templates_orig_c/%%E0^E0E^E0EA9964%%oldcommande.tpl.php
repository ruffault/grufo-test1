<?php /* Smarty version 2.6.31, created on 2019-12-31 07:45:36
         compiled from it/oldcommande.tpl */ ?>
<div id="oldcommande">
...
'>Dettaglio dell'ordine</a>)
  ...
  <?php if ($this->_tpl_vars['oldcommande'][$this->_sections['oldcommande']['index']]['statut'] == 2): ?>
    <?php if ($this->_tpl_vars['oldcommande'][$this->_sections['oldcommande']['index']]['refus'] != ''): ?>
      <em>motivo: <?php echo $this->_tpl_vars['oldcommande'][$this->_sections['oldcommande']['index']]['refus']; ?>
</em>
    <?php endif; ?>
  <?php else: ?>
