<?php /* Smarty version 2.6.31, created on 2019-11-18 00:05:54
         compiled from en/showresult.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'product_link', 'en/showresult.tpl', 7, false),array('modifier', 'utf8_encode', 'en/showresult.tpl', 17, false),array('modifier', 'truncate', 'en/showresult.tpl', 84, false),array('function', 'cycle', 'en/showresult.tpl', 50, false),)), $this); ?>
<div id="showresult">
...
"> <?php echo ((is_array($_tmp=$this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['nom'])) ? $this->_run_mod_handler('utf8_encode', true, $_tmp) : utf8_encode($_tmp)); ?>
  		...
  		<dd><em>By <?php echo ((is_array($_tmp=$this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['auteur'])) ? $this->_run_mod_handler('utf8_encode', true, $_tmp) : utf8_encode($_tmp)); ?>
</em></dd>
  		<dd>
				<?php if ($this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['disponible'] == 0 && $this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['delai_reapprovisionnement'] && $this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['prix'] != '0.00'): ?>
					Item available in <?php echo $this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['delai_reapprovisionnement']; ?>
 days
 ...
 € excl. VAT (<?php echo $this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['prix_rabais']; ?>
€ incl. VAT)<br />
        <?php else: ?>
          <?php echo $this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['prix_rabais']; ?>
 € incl. VAT (<?php echo $this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['prix_rabais_ht']; ?>
€ excl. VAT)<br />
        <?php endif; ?>
...
€ excl. VAT(<?php echo $this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['prix']; ?>
€ incl. VAT)
        <?php else: ?>
      		<?php echo $this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['prix']; ?>
€ incl. VAT(<?php echo $this->_tpl_vars['resultat'][$this->_sections['resultat']['index']]['prix_ht']; ?>
€ excl. VAT)
        <?php endif; ?>
      <?php endif; ?>
      </strong>
...
You may also <a href="<?php echo $this->_tpl_vars['urlsite']; ?>
catalogue-dictionnaire-et-lexique-c0">browse the catalogue</a> or use the categories in the search bar on the left-hand side menu.
</p>
