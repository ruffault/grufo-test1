<?php /* Smarty version 2.6.31, created on 2019-11-18 03:40:22
         compiled from de/catalogue-editeur.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'utf8_encode', 'de/catalogue-editeur.tpl', 1, false),array('modifier', 'strtolower', 'de/catalogue-editeur.tpl', 1, false),array('modifier', 'ucwords', 'de/catalogue-editeur.tpl', 1, false),array('modifier', 'product_link', 'de/catalogue-editeur.tpl', 5, false),array('modifier', 'truncate', 'de/catalogue-editeur.tpl', 16, false),array('function', 'cycle', 'de/catalogue-editeur.tpl', 4, false),)), $this); ?>
	<h2><span class="deco">></span>Katalog von Herausgeber : <?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['nomediteur'])) ? $this->_run_mod_handler('utf8_encode', true, $_tmp) : utf8_encode($_tmp)))) ? $this->_run_mod_handler('strtolower', true, $_tmp) : strtolower($_tmp)))) ? $this->_run_mod_handler('ucwords', true, $_tmp) : ucwords($_tmp)); ?>
</h2>
	<table id='vitrine'>	
