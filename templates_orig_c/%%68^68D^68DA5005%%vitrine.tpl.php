<?php /* Smarty version 2.6.31, created on 2019-10-30 01:08:46
         compiled from fr/vitrine.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'categ_link', 'fr/vitrine.tpl', 4, false),array('modifier', 'utf8_encode', 'fr/vitrine.tpl', 4, false),array('modifier', 'truncate', 'fr/vitrine.tpl', 4, false),array('modifier', 'product_link', 'fr/vitrine.tpl', 5, false),)), $this); ?>
﻿<div id='vithome'>
...
/img/no-image.gif" width=56></a>
								<?php else: ?>
									<a href="<?php echo $this->_tpl_vars['urlsite']; ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['id_produit'])) ? $this->_run_mod_handler('product_link', true, $_tmp, $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['nom'], $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['categorie']) : product_link($_tmp, $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['nom'], $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['categorie'])); ?>
"><img class="reflect"alt="<?php echo ((is_array($_tmp=$this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['nom'])) ? $this->_run_mod_handler('utf8_encode', true, $_tmp) : utf8_encode($_tmp)); ?>
