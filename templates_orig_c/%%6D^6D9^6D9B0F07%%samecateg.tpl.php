<?php /* Smarty version 2.6.31, created on 2019-11-18 03:40:47
         compiled from it/samecateg.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'product_link', 'it/samecateg.tpl', 9, false),array('modifier', 'utf8_encode', 'it/samecateg.tpl', 15, false),array('function', 'cycle', 'it/samecateg.tpl', 37, false),)), $this); ?>
...
€ tasse escluse (<?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix_rabais']; ?>
€ TTC)</strong>
        <?php else: ?>
          <strong><?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix_rabais']; ?>
€ tasse incluse (<?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix_rabais_ht']; ?>
€ HT)</strong>
        <?php endif; ?>
        </span>
...
€ tasse escluse(<?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix']; ?>
€ TTC)</strong>
        <?php else: ?>
      		<strong><?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix']; ?>
€ tasse incluse(<?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix_ht']; ?>
€ HT)</strong>
        <?php endif; ?>
        </span>
      <?php endif; ?>
