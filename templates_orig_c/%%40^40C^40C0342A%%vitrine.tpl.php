<?php /* Smarty version 2.6.31, created on 2019-10-30 17:56:42
         compiled from de/vitrine.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'categ_link', 'de/vitrine.tpl', 4, false),array('modifier', 'utf8_encode', 'de/vitrine.tpl', 4, false),array('modifier', 'truncate', 'de/vitrine.tpl', 4, false),array('modifier', 'product_link', 'de/vitrine.tpl', 5, false),)), $this); ?>
<div id='vithome'>
...
"/></a>
 ...
 € zzgl. MwSt (<?php echo $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['prix_rabais']; ?>
 € einschl. MwSt)</strong>
      <?php else: ?>
        <strong><?php echo $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['prix_rabais']; ?>
 € einschl. MwSt (<?php echo $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['prix_rabais_ht']; ?>
 € zzgl. MwSt)</strong>
      <?php endif; ?>
    <?php else: ?>
      <?php if ($_SESSION['ht'] == 'ht'): ?>
    		<strong><?php echo $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['prix_ht']; ?>
 € zzgl. MwSt (<?php echo $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['prix']; ?>
 € einschl. MwSt)</strong>
      <?php else: ?>
    		<strong><?php echo $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['prix']; ?>
 € einschl. MwSt (<?php echo $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['prix_ht']; ?>
 € zzgl. MwSt)</strong>
      <?php endif; ?>
    <?php endif; ?>
	</div>
