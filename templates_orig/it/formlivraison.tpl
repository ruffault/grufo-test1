<div id='formlivraison'>
  ...
  <form method="post" action="{$urlsite}verifformlivraison.php">
    ...
    <input type="image" name="livraison_submit" value="Usa questo indirizzo" src="{$urlsite}lang/{$applicationlang}/img/adresse.gif" />
  </form>
  Ou
  <br />
  <br />
  <form method="post" action="{$urlsite}verifformlivraison.php">
    ...
    <input type="image" name="livraison_submit" value="Usa un altro indirizzo" src="{$urlsite}lang/{$applicationlang}/img/autreadresse.gif" />
  </form>
  </div>
</div>