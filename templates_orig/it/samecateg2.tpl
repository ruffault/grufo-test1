    ...
    <div>
      ...
      {if $samecateg2[samecateg2].rabais != '0.00' && $samecateg2[samecateg2].prix ne '0.00'}
        {if $smarty.session.ht  == "ht"}
          <strong>{$samecateg2[samecateg2].prix_rabais_ht}€ tasse escluse ({$samecateg2[samecateg2].prix_rabais}€ TTC)</strong>
        {else}
          <strong>{$samecateg2[samecateg2].prix_rabais}€ tasse incluse ({$samecateg2[samecateg2].prix_rabais_ht}€ HT)</strong>
        {/if}
      {elseif $samecateg2[samecateg2].prix ne '0.00'}
        {if $smarty.session.ht  == "ht"}
      		<strong>{$samecateg2[samecateg2].prix_ht}€ tasse escluse({$samecateg2[samecateg2].prix}€ TTC)</strong>
        {else}
      		<strong>{$samecateg2[samecateg2].prix}€ tasse incluse({$samecateg2[samecateg2].prix_ht}€ HT)</strong>
        {/if}
      {/if}
      </dd>
    	</dl>
