  ...
  <div>
      ...
      {if $samecateg[samecateg].rabais != '0.00' && $samecateg[samecateg].prix ne '0.00'}
        ...
        {if $smarty.session.ht  == "ht"}
          <strong>{$samecateg[samecateg].prix_rabais_ht}€ tasse escluse ({$samecateg[samecateg].prix_rabais}€ TTC)</strong>
        {else}
          <strong>{$samecateg[samecateg].prix_rabais}€ tasse incluse ({$samecateg[samecateg].prix_rabais_ht}€ HT)</strong>
        {/if}
        </span>
      {elseif $samecateg[samecateg].prix ne '0.00'}
        <span class='prix'>
        {if $smarty.session.ht  == "ht"}
      		<strong>{$samecateg[samecateg].prix_ht}€ tasse escluse({$samecateg[samecateg].prix}€ TTC)</strong>
        {else}
      		<strong>{$samecateg[samecateg].prix}€ tasse incluse({$samecateg[samecateg].prix_ht}€ HT)</strong>
        {/if}
        </span>
      {/if}
      </dd>
