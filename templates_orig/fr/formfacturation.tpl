<div id='formfacturation'>
  ...
  <form method="post" action="{$urlsite}verifformfacturation.php">
    ...
    <input type="image" name="facturation_submit" value="Utiliser cette adresse" src="{$urlsite}lang/{$applicationlang}/img/adresse.gif" />
  </form>
  Ou
  <br />
  <br />
  <form method="post" action="{$urlsite}verifformfacturation.php">
    ...
    <input type="image" name="facturation_submit" value="Utiliser une autre adresse" src="{$urlsite}lang/{$applicationlang}/img/autreadresse.gif" />
  </form>
  </div>
</div>
