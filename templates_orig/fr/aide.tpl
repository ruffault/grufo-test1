...
plus rapidement, mémoriser votre <a href='{$urlsite}index.php?page=showpanier'>panier</a> et, si vous le désirez, recevoir notre
...
de vos commandes dans la partie <a href="{$urlsite}index.php?page=oldcommande">suivre mes
...
<p>La recherche avancée est disponible via le lien <a href='{$urlsite}index.php?page=advancedsearch'>Recherche avancée</a>
...
<p>
<a href='{$urlsite}catalogue-dictionnaire-et-lexique-c0'>Le catalogue</a> vous permet de rechercher des
...
à la page principale du catalogue avec le lien <a href="{$urlsite}catalogue-dictionnaire-et-lexique-c0">catalogue</a>.</p>
...
<p>Dès lors que vous souhaitez passer votre commande, cliquez sur <a href="{$urlsite}verifmembre.php">Valider
...
prévu à cet effet dans la section <a href='{$urlsite}index.php?page=contact'>contact</a>. Nous nous ferons une joie de vous
...
<p>
  ...
  <a href="{$urlsite}index.php?page=lastpass">le formulaire de récupération du mot de
