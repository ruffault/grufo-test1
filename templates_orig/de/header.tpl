...
<head>
  ...
  {elseif $nomvitrine == 1}
    <title>{$namesite} - Der Wörterbuchfachhandel - über 4.000 Titel für 
    Sprachwissenschaftler und Übersetzer!</title>
  {else}
...
<div id="all">
  <div id="mininavi">
    <img src="{$urlsite}css/caddy.gif" alt="" /><a href="{$urlsite}index.php?page=showpanier">Warenkorb</a> |
    <a href="{$urlsite}index.php?page=myaccount">Mein Konto</a> |  
    <a href="{$urlsite}index.php?page=aide">Hilfe</a>
    {if $smarty.session.id_membre}| <a href="{$urlsite}logout.php">Beenden</a>{/if}
		<div id='lang'>
	...
	<div class="header">
		...
		{elseif $nomvitrine == 1}
			<h1>{$namesite} - Der Wörterbuchfachhandel - über 4.000 Titel
  für Sprachwissenschaftler und Übersetzer!</h1>
		{else}
			<h1>{$namesite}</h1>
		{/if}
		<a href="{$urlsite}index.php" id="logo"></a>
		<p>Der Wörterbuchfachhandel - Sprachkurse, CDROMS, Sprachführer,
		Glossare, Fachwortverzeichnisse, Terminologie und vieles mehr! </p>
		<ul>
			<li><a href="#innerleft">Zum Menü</a></li>
			<li><a href="#search">Zur Suche</a></li>
			<li><a href="#innercenter">Zum Inhalt</a></li>
		</ul>
	</div>
</div>
...
<div class="wrapper">
  ...
  <div class="wide">
    <div id="nav">
      <ul>
        <li{if !isset($smarty.get.page)} id="current"{/if}><a href="{$urlsite}index.php">Startseite</a></li>
        <li{if $smarty.get.page == "catalogue"} id="current"{/if}><a href="{$urlsite}catalogue-dictionnaire-et-lexique-c0">Katalog</a></li>
        ...
        <li{if $smarty.get.page == "myaccount"} id="current"{/if}><a href="{$urlsite}index.php?page=myaccount">Mein Konto</a></li>
        <li{if $smarty.get.page == "showpanier"} id="current"{/if}><a href="{$urlsite}index.php?page=showpanier">Warenkorb</a></li>
        <li{if $smarty.get.page == "contact"} id="current"{/if}><a href="{$urlsite}index.php?page=contact">Kontakt</a></li>
        <!-- <li{if $smarty.get.page == "blog"} id="current"{/if}><a href="http://www.dicoland.com/blog/">Blog</a></li> -->
                ...
                <div id="search">
                  <form method="get" action="{$urlsite}index.php">
                        ...
                        <a href="{$urlsite}index.php?page=advancedsearch" id="advancedsearch">Erweiterte Suche</a>
                  </p>
                        </form>
                </div>
        </div>
