    ...
    <div>
      ...
      {if $samecateg2[samecateg2].rabais != '0.00' && $samecateg2[samecateg2].prix ne '0.00'}
        {if $smarty.session.ht  == "ht"}
          <strong>{$samecateg2[samecateg2].prix_rabais_ht}€ zzgl. MwSt ({$samecateg2[samecateg2].prix_rabais}€ einschl. MwSt)</strong>
        {else}
          <strong>{$samecateg2[samecateg2].prix_rabais}€ einschl. MwSt ({$samecateg2[samecateg2].prix_rabais_ht}€ zzgl. MwSt)</strong>
        {/if}
      {elseif $samecateg2[samecateg2].prix ne '0.00'}
        {if $smarty.session.ht  == "ht"}
      		<strong>{$samecateg2[samecateg2].prix_ht}€ zzgl. MwSt({$samecateg2[samecateg2].prix}€ einschl. MwSt)</strong>
        {else}
      		<strong>{$samecateg2[samecateg2].prix}€ einschl. MwSt({$samecateg2[samecateg2].prix_ht}€ zzgl. MwSt)</strong>
        {/if}
      {/if}
      </dd>
    	</dl>
