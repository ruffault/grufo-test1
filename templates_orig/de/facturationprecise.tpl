    ...
    <p class="field">
      <label for="i_civilite">*Anrede</label>
		{if !isset($smarty.session.facturation_civilite) or $smarty.session.facturation_civilite == 1}
		  <input type='hidden' name='facturation_precise' value='1' />
		  <input type='radio' id="i_civilite" name='facturation_civilite' value='1' checked="checked" /> Herr
		{else}
			<input type='radio' id="i_civilite" name='facturation_civilite' value='1' /> Herr
		{/if}
		{if $smarty.session.facturation_civilite == 2}
			<input type='radio' id="i_civilite" name='facturation_civilite' value='2' checked="checked" /> Frau
		{else}
			<input type='radio' id="i_civilite" name='facturation_civilite' value='2' /> Frau
    {/if}
		{if $smarty.session.facturation_civilite == 3}
			<input type='radio' id="i_civilite" name='facturation_civilite' value='3' checked="checked" /> Fräulein
		{else}
			<input type='radio' id="i_civilite" name='facturation_civilite' value='3' /> Fräulein
    {/if}
