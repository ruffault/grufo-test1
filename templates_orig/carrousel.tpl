...
<div class="menu_list" id="secondpane"> <!--Code for menu starts here-->
		...
		{/php}
		<h4><a href="http://www.aptetudes.com" target="_blank"><img src="/img/ecran-aptetudes.png" width="133" height="88" border="0" /></a><br /></h4>
				Aide aux devoirs, soutien scolaire et stages à domicile dans toutes les matières (Maths, lettres, Sciences, Langues…) du primaire à Bac+2.<br />
				Organisme prestataire agréé par l’Etat. Possibilité de réduction ou de crédit d’impôt.
		{php}
		}else{
		{/php}
