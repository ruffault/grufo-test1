...
{else}
  ...
  <tr>
  <td>
    <h3><img src="{$urlsite}css/puce2.gif" alt="" /> <a href="{$urlsite}dictionnaires-electroniques-c312">Diccionarios Digital</a></h3>
    <a href="{$urlsite}dictionnaires-electroniques-c312">Diccionarios electrónicos</a>, <a href="{$urlsite}E-Book-c351">E-Book</a>, <a href="{$urlsite}cd-rom-c59">CD-ROM</a>, <a href="{$urlsite}logiciel-c174">Software</a>...
