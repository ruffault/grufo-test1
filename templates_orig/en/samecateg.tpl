  ...
  <div>
      ...
      {if $samecateg[samecateg].rabais != '0.00' && $samecateg[samecateg].prix ne '0.00'}
        ...
        {if $smarty.session.ht  == "ht"}
          <strong>{$samecateg[samecateg].prix_rabais_ht}€ excl. VAT ({$samecateg[samecateg].prix_rabais}€ incl. VAT)</strong>
        {else}
          <strong>{$samecateg[samecateg].prix_rabais}€ incl. VAT ({$samecateg[samecateg].prix_rabais_ht}€ excl. VAT)</strong>
        {/if}
        </span>
      {elseif $samecateg[samecateg].prix ne '0.00'}
        <span class='prix'>
        {if $smarty.session.ht  == "ht"}
      		<strong>{$samecateg[samecateg].prix_ht}€ excl. VAT({$samecateg[samecateg].prix}€ incl. VAT)</strong>
        {else}
      		<strong>{$samecateg[samecateg].prix}€ incl. VAT({$samecateg[samecateg].prix_ht}€ excl. VAT)</strong>
        {/if}
        </span>
      {/if}
      </dd>
