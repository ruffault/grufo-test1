...
Once registered, you can <a href='{$urlsite}verifmembre.php'>confirm your orders</a>
more rapidly, save your <a href='{$urlsite}index.php?page=showpanier'>basket</a> and receive our newsletter if you
so wish.</p>
...
of your order online in the  <a href="{$urlsite}index.php?page=oldcommande">follow up my
...
<p>The advanced search is available through the <a href='{$urlsite}index.php?page=advancedsearch'>Advanced search</a>
...
<p>
<a href='{$urlsite}catalogue-0-tous.html'>Catalogue</a> enables you to search for
...
main page of the catalogue through the <a href="{$urlsite}catalogue-0-tous.html">catalogue</a> link.</p>
...
<p>As soon as you want make an order, click on <a href="{$urlsite}verifmembre.php">Confirm
...
<a href='{$urlsite}index.php?page=contact'>contact</a> section. We will be delighted to reply
...
<p>
  ...
  <a href="{$urlsite}index.php?page=lastpass">the password recovery
