...
//on crée une nouvelle commande non validée
...
$subjectadmin = "Commande référence " . $oldcommande . " à traiter";
$messageadmin = "Bonjour,\n\nLa commande référencé " . $oldcommande
. " viens d'être validée le " . date("Y/m/d") . " à "
