<?php /* Smarty version 2.6.31, created on 2019-10-30 17:56:44
         compiled from es/vitrine.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'categ_link', 'es/vitrine.tpl', 4, false),array('modifier', 'utf8_encode', 'es/vitrine.tpl', 4, false),array('modifier', 'truncate', 'es/vitrine.tpl', 4, false),array('modifier', 'product_link', 'es/vitrine.tpl', 5, false),)), $this); ?>
<div id='vithome'>
...
"/></a>
 ...
 € sin IVA (<?php echo $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['prix_rabais']; ?>
 € con IVA)</strong>
      <?php else: ?>
        <strong><?php echo $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['prix_rabais']; ?>
 € con IVA (<?php echo $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['prix_rabais_ht']; ?>
 € sin IVA)</strong>
      <?php endif; ?>
    <?php else: ?>
      <?php if ($_SESSION['ht'] == 'ht'): ?>
    		<strong><?php echo $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['prix_ht']; ?>
 € sin IVA (<?php echo $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['prix']; ?>
 € con IVA)</strong>
      <?php else: ?>
    		<strong><?php echo $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['prix']; ?>
 € con IVA (<?php echo $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['prix_ht']; ?>
 € sin IVA)</strong>
      <?php endif; ?>
    <?php endif; ?>
    		</div>
...
addtopanier.php?nbpage=1&amp;pagecourante=1&amp;nbresult=1">
      					<div>
        					<input type="image" value="Añadir a mi cesta de la compra" src="<?php echo $this->_tpl_vars['urlsite']; ?>
lang/<?php echo $this->_tpl_vars['applicationlang']; ?>
/img/addpan.png"/>
