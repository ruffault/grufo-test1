<?php /* Smarty version 2.6.31, created on 2024-05-17 12:16:10
         compiled from fr/formfacturation.tpl */ ?>
<div id='formfacturation'>
  <h2><span class="deco">></span> 3 - Adresse de facturation</h2>
...
verifformfacturation.php">
    ...
    <input type="image" name="facturation_submit" value="Utiliser cette adresse" src="<?php echo $this->_tpl_vars['urlsite']; ?>
...
verifformfacturation.php">
    ...
    <input type="image" name="facturation_submit" value="Utiliser une autre adresse" src="<?php echo $this->_tpl_vars['urlsite']; ?>
lang/<?php echo $this->_tpl_vars['applicationlang']; ?>
