<?php /* Smarty version 2.6.31, created on 2019-11-17 17:45:58
         compiled from it/sameauteur.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'product_link', 'it/sameauteur.tpl', 10, false),array('modifier', 'utf8_encode', 'it/sameauteur.tpl', 16, false),array('function', 'cycle', 'it/sameauteur.tpl', 34, false),)), $this); ?>
...
€ tasse escluse (<?php echo $this->_tpl_vars['sameauteur'][$this->_sections['sameauteur']['index']]['prix_rabais']; ?>
€ TTC)</strong>
        <?php else: ?>
          <strong><?php echo $this->_tpl_vars['sameauteur'][$this->_sections['sameauteur']['index']]['prix_rabais']; ?>
€ tasse incluse (<?php echo $this->_tpl_vars['sameauteur'][$this->_sections['sameauteur']['index']]['prix_rabais_ht']; ?>
€ HT)</strong>
        <?php endif; ?>
      <?php else: ?>
...
€ tasse escluse(<?php echo $this->_tpl_vars['sameauteur'][$this->_sections['sameauteur']['index']]['prix']; ?>
€ TTC)</strong>
...
€ tasse incluse(<?php echo $this->_tpl_vars['sameauteur'][$this->_sections['sameauteur']['index']]['prix_ht']; ?>
€ HT)</strong>
        <?php endif; ?>
      <?php endif; ?>
      </dd>
