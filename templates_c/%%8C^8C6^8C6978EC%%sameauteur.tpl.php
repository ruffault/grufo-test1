<?php /* Smarty version 2.6.31, created on 2019-11-17 17:45:57
         compiled from en/sameauteur.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'product_link', 'en/sameauteur.tpl', 10, false),array('modifier', 'utf8_encode', 'en/sameauteur.tpl', 16, false),array('function', 'cycle', 'en/sameauteur.tpl', 34, false),)), $this); ?>
...
€ excl. VAT (<?php echo $this->_tpl_vars['sameauteur'][$this->_sections['sameauteur']['index']]['prix_rabais']; ?>
€ incl. VAT)</strong>
        <?php else: ?>
          <strong><?php echo $this->_tpl_vars['sameauteur'][$this->_sections['sameauteur']['index']]['prix_rabais']; ?>
€ incl. VAT (<?php echo $this->_tpl_vars['sameauteur'][$this->_sections['sameauteur']['index']]['prix_rabais_ht']; ?>
€ excl. VAT)</strong>
        <?php endif; ?>
      <?php else: ?>
...
€ excl. VAT (<?php echo $this->_tpl_vars['sameauteur'][$this->_sections['sameauteur']['index']]['prix']; ?>
€ incl. VAT)</strong>
...
€ incl. VAT (<?php echo $this->_tpl_vars['sameauteur'][$this->_sections['sameauteur']['index']]['prix_ht']; ?>
€ excl. VAT)</strong>
        <?php endif; ?>
      <?php endif; ?>
      </dd>
