<?php /* Smarty version 2.6.31, created on 2024-05-17 00:15:49
         compiled from fr/sameauteur.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'product_link', 'fr/sameauteur.tpl', 10, false),array('modifier', 'utf8_encode', 'fr/sameauteur.tpl', 16, false),array('function', 'cycle', 'fr/sameauteur.tpl', 34, false),)), $this); ?>
<?php if ($this->_tpl_vars['sameauteur']): ?>
<div id="sameauteur"><br>
  <h4><span class="deco">&gt;</span>Du même auteur</h4>
  <div>
...
€ HT (<?php echo $this->_tpl_vars['sameauteur'][$this->_sections['sameauteur']['index']]['prix_rabais']; ?>
€ TTC)</strong>
        <?php else: ?>
          <strong><?php echo $this->_tpl_vars['sameauteur'][$this->_sections['sameauteur']['index']]['prix_rabais']; ?>
€ TTC (<?php echo $this->_tpl_vars['sameauteur'][$this->_sections['sameauteur']['index']]['prix_rabais_ht']; ?>
€ HT)</strong>
        <?php endif; ?>
      <?php else: ?>
...
€ HT(<?php echo $this->_tpl_vars['sameauteur'][$this->_sections['sameauteur']['index']]['prix']; ?>
€ TTC)</strong>
...
€ TTC(<?php echo $this->_tpl_vars['sameauteur'][$this->_sections['sameauteur']['index']]['prix_ht']; ?>
€ HT)</strong>
        <?php endif; ?>
      <?php endif; ?>
      </dd>
