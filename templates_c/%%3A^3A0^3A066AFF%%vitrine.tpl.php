<?php /* Smarty version 2.6.31, created on 2019-10-30 17:56:39
         compiled from en/vitrine.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'categ_link', 'en/vitrine.tpl', 4, false),array('modifier', 'utf8_encode', 'en/vitrine.tpl', 4, false),array('modifier', 'truncate', 'en/vitrine.tpl', 4, false),array('modifier', 'product_link', 'en/vitrine.tpl', 5, false),)), $this); ?>
<div id='vithome'>
...
"/></a>
 ...
 € excl. VAT (<?php echo $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['prix_rabais']; ?>
 € incl. VAT)</strong>
      <?php else: ?>
        <strong><?php echo $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['prix_rabais']; ?>
 € incl. VAT (<?php echo $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['prix_rabais_ht']; ?>
 € excl. VAT)</strong>
      <?php endif; ?>
    <?php else: ?>
      <?php if ($_SESSION['ht'] == 'ht'): ?>
    		<strong><?php echo $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['prix_ht']; ?>
 € excl. VAT (<?php echo $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['prix']; ?>
 € incl. VAT)</strong>
      <?php else: ?>
    		<strong><?php echo $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['prix']; ?>
 € incl. VAT (<?php echo $this->_tpl_vars['vitrine'][$this->_sections['vitrine']['index']]['prix_ht']; ?>
 € excl. VAT)</strong>
      <?php endif; ?>
    <?php endif; ?>
    		</div>
