<?php /* Smarty version 2.6.31, created on 2019-11-18 03:40:42
         compiled from es/buysame.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'utf8_encode', 'es/buysame.tpl', 3, false),array('modifier', 'product_link', 'es/buysame.tpl', 8, false),array('modifier', 'htmlentities', 'es/buysame.tpl', 8, false),array('modifier', 'lower', 'es/buysame.tpl', 8, false),array('modifier', 'capitalize', 'es/buysame.tpl', 8, false),)), $this); ?>
<div id="buysame_all">
<?php if (isset ( $this->_tpl_vars['tab_same'] )): ?>
<h4><span class="deco">&gt;</span>Los internautas que han comprado <?php echo ((is_array($_tmp=$this->_tpl_vars['showproduct']['nom'])) ? $this->_run_mod_handler('utf8_encode', true, $_tmp) : utf8_encode($_tmp)); ?>
 también han comprado:</h4>
<div>	
	<ul id="buysame">
