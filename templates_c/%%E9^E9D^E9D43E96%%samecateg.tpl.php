<?php /* Smarty version 2.6.31, created on 2019-11-18 00:05:58
         compiled from en/samecateg.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'product_link', 'en/samecateg.tpl', 9, false),array('modifier', 'utf8_encode', 'en/samecateg.tpl', 15, false),array('function', 'cycle', 'en/samecateg.tpl', 37, false),)), $this); ?>
...
€ excl. VAT (<?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix_rabais']; ?>
€ incl. VAT)</strong>
        <?php else: ?>
          <strong><?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix_rabais']; ?>
€ incl. VAT (<?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix_rabais_ht']; ?>
€ excl. VAT)</strong>
        <?php endif; ?>
        </span>
...
€ excl. VAT(<?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix']; ?>
€ incl. VAT)</strong>
        <?php else: ?>
      		<strong><?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix']; ?>
€ incl. VAT(<?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix_ht']; ?>
€ excl. VAT)</strong>
        <?php endif; ?>
        </span>
      <?php endif; ?>
