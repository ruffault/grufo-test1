<?php /* Smarty version 2.6.31, created on 2024-05-16 10:11:45
         compiled from fr/header.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'utf8_encode', 'fr/header.tpl', 10, false),array('modifier', 'htmlentities', 'fr/header.tpl', 26, false),)), $this); ?>
﻿<?php echo '<?xml'; ?>
...
logout.php">Quitter</a><?php endif; ?>
		<div id='lang'>
			<a href='<?php echo $this->_tpl_vars['originalurl']; ?>
fr' title='Français'><img src='<?php echo $this->_tpl_vars['urlsite']; ?>
img/flag_fr.gif' alt='Français' /></a>
			<a href='<?php echo $this->_tpl_vars['originalurl']; ?>
en' title='English'><img src='<?php echo $this->_tpl_vars['urlsite']; ?>
img/flag_en.gif' alt='English' /></a>
			<a href='<?php echo $this->_tpl_vars['originalurl']; ?>
de' title='Deutsch'><img src='<?php echo $this->_tpl_vars['urlsite']; ?>
img/flag_de.gif' alt='Deutsch' /></a>
			<a href='<?php echo $this->_tpl_vars['originalurl']; ?>
es' title='Español'><img src='<?php echo $this->_tpl_vars['urlsite']; ?>
img/flag_es.gif' alt='Español' /></a>
			<a href='<?php echo $this->_tpl_vars['originalurl']; ?>
it' title='Italiano'><img src='<?php echo $this->_tpl_vars['urlsite']; ?>
...
E-Book-c351">E-Book</a></li>
        <li<?php if ($_GET['page'] == 'occasion'): ?> id="current"<?php endif; ?>><a href="<?php echo $this->_tpl_vars['urlsite']; ?>
...
contact">Contact</a></li>
        ...
        <li<?php if ($_GET['page'] == 'aide'): ?> id="current"<?php endif; ?>><a href="<?php echo $this->_tpl_vars['urlsite']; ?>
...
index.php">
                        ...
                        <input id="searchbar" name="quicksearch" type="text" value="<?php echo ((is_array($_tmp=$_GET['quicksearch'])) ? $this->_run_mod_handler('utf8_encode', true, $_tmp) : utf8_encode($_tmp)); ?>
" />
