<?php /* Smarty version 2.6.31, created on 2019-11-18 03:40:06
         compiled from en/showfuture.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'product_link', 'en/showfuture.tpl', 17, false),array('modifier', 'utf8_encode', 'en/showfuture.tpl', 17, false),)), $this); ?>
<div id="showfuture">
...
" />
      ...
      <input type="image" name="remettrepanier" value="Add to basket" src="<?php echo $this->_tpl_vars['urlsite']; ?>
lang/<?php echo $this->_tpl_vars['applicationlang']; ?>
/img/ajouterpanier.gif" alt="Add to basket" />
    </form>
    <form method="post" action="<?php echo $this->_tpl_vars['urlsite']; ?>
remfrompanier.php">
      <input type="hidden" name="id" value="<?php echo $this->_tpl_vars['future'][$this->_sections['future']['index']]['id_produit']; ?>
" />
      ...
      <input type="image" name="supprimer" value="Delete" src="<?php echo $this->_tpl_vars['urlsite']; ?>
lang/<?php echo $this->_tpl_vars['applicationlang']; ?>
/img/supprimer.gif" alt="Delete" />
    </form>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['future'][$this->_sections['future']['index']]['nom'])) ? $this->_run_mod_handler('utf8_encode', true, $_tmp) : utf8_encode($_tmp)); ?>
    ...
    <?php if ($this->_tpl_vars['future'][$this->_sections['future']['index']]['disponible'] == 1): ?>
      available
    <?php else: ?>
      available in <?php echo $this->_tpl_vars['future'][$this->_sections['future']['index']]['delai_reapprovisionnement']; ?>
 days
    <?php endif; ?>
    <br />
  <?php endfor; endif; ?>
