<?php /* Smarty version 2.6.31, created on 2019-11-18 01:19:53
         compiled from de/samecateg.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'product_link', 'de/samecateg.tpl', 9, false),array('modifier', 'utf8_encode', 'de/samecateg.tpl', 15, false),array('function', 'cycle', 'de/samecateg.tpl', 37, false),)), $this); ?>
...
" alt="" /></ahref="<?php echo $this->_tpl_vars['urlsite']; ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['id_produit'])) ? $this->_run_mod_handler('product_link', true, $_tmp, $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['nom'], $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['categorie']) : product_link($_tmp, $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['nom'], $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['categorie'])); ?>
">
          <?php endif; ?>
        </span>
...
€ zzgl. MwSt (<?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix_rabais']; ?>
€ einschl. MwSt)</strong>
        <?php else: ?>
          <strong><?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix_rabais']; ?>
€ einschl. MwSt (<?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix_rabais_ht']; ?>
€ zzgl. MwSt)</strong>
        <?php endif; ?>
        </span>
...
€ zzgl. MwSt(<?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix']; ?>
€ einschl. MwSt)</strong>
        <?php else: ?>
      		<strong><?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix']; ?>
€ einschl. MwSt(<?php echo $this->_tpl_vars['samecateg'][$this->_sections['samecateg']['index']]['prix_ht']; ?>
€ zzgl. MwSt)</strong>
        <?php endif; ?>
        </span>
      <?php endif; ?>
