<?php /* Smarty version 2.6.31, created on 2019-11-17 17:45:58
         compiled from it/samecateg2.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'product_link', 'it/samecateg2.tpl', 10, false),array('modifier', 'utf8_encode', 'it/samecateg2.tpl', 16, false),array('function', 'cycle', 'it/samecateg2.tpl', 34, false),)), $this); ?>
<?php if ($this->_tpl_vars['samecateg2']): ?>
  <div id="samecateg2"><br>
    <h4><span class="deco">&gt;</span>Opere nella stessa categoria</h4>
    <div>
...
€ tasse escluse (<?php echo $this->_tpl_vars['samecateg2'][$this->_sections['samecateg2']['index']]['prix_rabais']; ?>
€ TTC)</strong>
        <?php else: ?>
          <strong><?php echo $this->_tpl_vars['samecateg2'][$this->_sections['samecateg2']['index']]['prix_rabais']; ?>
€ tasse incluse (<?php echo $this->_tpl_vars['samecateg2'][$this->_sections['samecateg2']['index']]['prix_rabais_ht']; ?>
€ HT)</strong>
        <?php endif; ?>
...
€ tasse escluse(<?php echo $this->_tpl_vars['samecateg2'][$this->_sections['samecateg2']['index']]['prix']; ?>
€ TTC)</strong>
        <?php else: ?>
      		<strong><?php echo $this->_tpl_vars['samecateg2'][$this->_sections['samecateg2']['index']]['prix']; ?>
€ tasse incluse(<?php echo $this->_tpl_vars['samecateg2'][$this->_sections['samecateg2']['index']]['prix_ht']; ?>
€ HT)</strong>
        <?php endif; ?>
      <?php endif; ?>
      </dd>
