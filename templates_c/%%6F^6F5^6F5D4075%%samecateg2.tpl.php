<?php /* Smarty version 2.6.31, created on 2019-11-17 17:45:57
         compiled from en/samecateg2.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'product_link', 'en/samecateg2.tpl', 10, false),array('modifier', 'utf8_encode', 'en/samecateg2.tpl', 16, false),array('function', 'cycle', 'en/samecateg2.tpl', 34, false),)), $this); ?>
<?php if ($this->_tpl_vars['samecateg2']): ?>
  <div id="samecateg2"><br>
    <h4><span class="deco">&gt;</span>In the same category</h4>
    <div>
...
€ excl. VAT (<?php echo $this->_tpl_vars['samecateg2'][$this->_sections['samecateg2']['index']]['prix_rabais']; ?>
€ incl. VAT)</strong>
        <?php else: ?>
          <strong><?php echo $this->_tpl_vars['samecateg2'][$this->_sections['samecateg2']['index']]['prix_rabais']; ?>
€ incl. VAT (<?php echo $this->_tpl_vars['samecateg2'][$this->_sections['samecateg2']['index']]['prix_rabais_ht']; ?>
€ excl. VAT)</strong>
        <?php endif; ?>
...
€ excl. VAT(<?php echo $this->_tpl_vars['samecateg2'][$this->_sections['samecateg2']['index']]['prix']; ?>
€ incl. VAT)</strong>
        <?php else: ?>
      		<strong><?php echo $this->_tpl_vars['samecateg2'][$this->_sections['samecateg2']['index']]['prix']; ?>
€ incl. VAT(<?php echo $this->_tpl_vars['samecateg2'][$this->_sections['samecateg2']['index']]['prix_ht']; ?>
€ excl. VAT)</strong>
        <?php endif; ?>
      <?php endif; ?>
      </dd>
